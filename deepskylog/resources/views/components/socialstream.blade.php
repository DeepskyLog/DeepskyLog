<div class="mb-2 mt-6 space-y-6">
    @if (! empty(\JoelButcher\Socialstream\Socialstream::providers()))
        <div class="relative flex items-center">
            ...
            <span class="shrink px-6 text-gray-400">
    ...
    <div class="grid gap-4">
        @foreach (\JoelButcher\Socialstream\Socialstream::providers() as $provider)
            <a
                class="flex w-full items-center justify-center gap-2 rounded-lg border border-gray-400 py-2.5 text-sm shadow-xs transition duration-200 hover:shadow-md"
