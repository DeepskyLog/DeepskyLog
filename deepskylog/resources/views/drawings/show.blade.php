    ...
    <div>
        <div class="max-w-screen mx-auto bg-gray-900 px-2 py-10 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                ...
                @if ($user == '')
                    <x-button gray icon="eye" class="mb-2" href="/cometdrawings">
                        {{ __('Show comet sketches') }}
                    </x-button>
                @else
                    <x-button gray icon="eye" class="mb-2" href="/cometdrawings/{{ $user->slug }}">
                        {{ __('Show comet sketches') }}
                    </x-button>
                @endif
            </div>
                        ...
                        @foreach ($sketches as $sketch)
                            <div class="mt-3 max-w-xl pr-3">
                                ...
                                <a
                                    ...
                                    <img width="400" src="/images/drawings/{{ $sketch->id }}.jpg" />
