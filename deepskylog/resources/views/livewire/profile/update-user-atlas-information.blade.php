<x-form-section submit="updateAtlasInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 text-sm text-gray-400 sm:col-span-5">
            <x-number
                id="overview"
                label="{!! __('Overview standard FoV (in arcminutes)') !!}"
                type="number"
                min="1"
                max="3600"
        ...
        <div class="col-span-6 text-sm text-gray-400 sm:col-span-5">
            <x-number
                id="lookup"
                label="{!! __('Lookup standard FoV (in arcminutes)') !!}"
                type="number"
                min="1"
                max="3600"
        ...
        <div class="col-span-6 text-sm text-gray-400 sm:col-span-5">
            <x-number
                id="detail"
                label="{!! __('Detail standard FoV (in arcminutes)') !!}"
                type="number"
                min="1"
                max="3600"
        ...
        <div class="col-span-6 text-sm text-gray-400 sm:col-span-5">
            <x-number
                id="overviewdsos"
                label="{!! __('Overview standard object magnitude') !!}"
                type="number"
                min="1.0"
                max="20.0"
                step="0.1"
        ...
        <div class="col-span-6 text-sm text-gray-400 sm:col-span-5">
            <x-number
                id="lookupdsos"
                label="{!! __('Lookup standard object magnitude') !!}"
                type="number"
                min="1.0"
                max="20.0"
                step="0.1"
        ...
        <div class="col-span-6 text-sm text-gray-400 sm:col-span-5">
            <x-number
                id="detaildsos"
                label="{!! __('Detail standard object magnitude') !!}"
                type="number"
                min="1.0"
                max="20.0"
                step="0.1"
        ...
        <div class="col-span-6 text-sm text-gray-400 sm:col-span-5">
            <x-number
                id="overviewstars"
                label="{!! __('Overview standard star magnitude') !!}"
                type="number"
                min="1.0"
                max="20.0"
                step="0.1"
        ...
        <div class="col-span-6 text-sm text-gray-400 sm:col-span-5">
            <x-number
                id="lookupstars"
                label="{!! __('Lookup standard star magnitude') !!}"
                type="number"
                min="1.0"
                max="20.0"
                step="0.1"
        ...
        <div class="col-span-6 text-sm text-gray-400 sm:col-span-5">
            <x-number
                id="detailstars"
                label="{!! __('Detail standard star magnitude') !!}"
                type="number"
                min="1.0"
                max="20.0"
                step="0.1"
        ...
        <div class="col-span-6 text-sm text-gray-400 sm:col-span-5">
            <x-number
                id="photosize1"
                label="{!! __('Standard size of first picture (in arcminutes)') !!}"
                type="number"
                min="1"
                max="3600"
        ...
        <div class="col-span-6 text-sm text-gray-400 sm:col-span-5">
            <x-number
                id="photosize2"
                label="{!! __('Standard size of second picture (in arcminutes)') !!}"
                type="number"
                min="1"
                max="3600"
        ...
        <div class="col-span-6 text-sm text-gray-400 sm:col-span-5">
            <x-number
                id="atlaspagefont"
                label="{!! __('Font size printed atlas pages (6..9)') !!}"
                type="number"
                min="6"
                max="9"
