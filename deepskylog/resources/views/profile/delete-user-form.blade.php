<x-action-section>
    ...
    <x-slot name="content">
        ...
        <x-modal.card blur title="{{ __('Delete Account') }}" wire:model.live="confirmingUserDeletion">
            ...
            <x-slot name="footer">
                ...
                <x-button negative class="ml-3" wire:click="deleteUser" wire:loading.attr="disabled">
                    {{ __('Delete Account') }}
                </x-button>
            </x-slot>
        </x-modal.card>
