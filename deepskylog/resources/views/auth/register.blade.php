<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                <x-input label="{{ __('Name') }}" id="name" class="block mt-1 w-full" type="text" name="name"
                    :value="old('name')" required autofocus autocomplete="name" />
            </div>

            <div class="mt-4">
                <x-input label="{{ __('User name') }}" id="username" class="block mt-1 w-full" type="text"
                    name="username" :value="old('username')" required autofocus autocomplete="username" />
            </div>

            <div class="mt-4">
                <x-input label="{{ __('Email') }}" id="email" class="block mt-1 w-full" type="email"
