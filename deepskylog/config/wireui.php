...
return [
    ...
    */
    ...
    'components' => [
        ...
        'dropdown' => [
            'class' => App\View\Components\DslDropdown::class,
            'alias' => 'dropdown',
        ],
        'dropdown.item' => [
            'class' => App\View\Components\DslDropdown\DslDropdownItem::class,
            'alias' => 'dropdown.item',
        ],
        'dropdown.header' => [
            'class' => App\View\Components\DslDropdown\DslDropdownHeader::class,
