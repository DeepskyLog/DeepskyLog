<?php // validate_change_observation.php - checks if the change new observation form is correctly filled in
...
if(!$_POST['day'] || !$_POST['month'] || !$_POST['year'] || (!$_POST['hours'] && strcmp($_POST['hours'], 0) != "0") || (!$_POST['minutes'] && strcmp($_POST['minutes'], 0) != "0"))
   ...
   elseif($_POST['observation']) // all fields filled in and observationid given
   {
      ...
      $objCometObservation->setComa($_POST['observation'], $coma);
      ...
      $objCometObservation->setTail($_POST['observation'], $tail);
      ...
      $objCometObservation->setPa($_POST['observation'], $pa);
      $objCometObservation->setChart($_POST['observation'], $_POST['icq_reference_key']);
      $objCometObservation->setMagnification($_POST['observation'], $_POST['magnification']);
      $objCometObservation->setMethode($_POST['observation'], $_POST['icq_method']);
      $objCometObservation->setDc($_POST['observation'], $_POST['condensation']);
