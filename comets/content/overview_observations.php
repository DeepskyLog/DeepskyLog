...
else overview_observations();

function overview_observations()
{ global $instDir,$baseURL,$step,$loggedUser,$dateformat,
         $objInstrument,$objCometObject,$objCometObservation,$objUtil,$objObserver,$objPresentations;
