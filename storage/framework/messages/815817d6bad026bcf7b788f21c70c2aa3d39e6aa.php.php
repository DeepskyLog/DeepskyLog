<li>
    ...
    <p>
        ...
        ?>
        <img src="<?php echo e(asset($file)); ?>" title=<?php echo e($illumination); ?> height="100px" width="100px" alt=<?php echo e($illumination); ?> />
    </p>
    ...
    ?>
    <?php echo e(_i("New moon")); ?>: <?php echo e($newMoonDate); ?>
