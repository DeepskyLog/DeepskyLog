...
define("LangIndexPleaseWait"															,"Pri�re d'attendre un moment pendant la recherche des donn�es...");
...
define("LangTitleview_observer_catalog"  									,"R�sultat recherche com�tes");
define("LangTitlerank_observers"         									,"Pr�sentation observateurs");

define("LangException000"																	,"Faute inconnue. Veuillez contacter les d�veloppeurs avec ce message.");
define("LangException001"																	,"Vous devez �tre connect� comme administrateur pour effectuer cette op�ration. Veuillez contacter les d�veloppeurs avec ce message.");
define("LangException002"																	,"Vous devez �tre connect� pour g�rer les endroits et les �quipements. Veuillez contacter les d�veloppeurs avec ce message.");
define("LangException002b"																,"Vous devez �tre connect� pour g�rer vos observations. Veuillez contacter les d�veloppeurs avec ce message.");
define("LangException002c"																,"Vous devez �tre connect� pour g�rer les objets. Veuillez contacter les d�veloppeurs avec ce message.");
define("LangException003"																	,"Vous voulez modifier un oculaire, bien que vous n'en avez pas s�lectionn�. Veuillez contacter les d�veloppeurs avec ce message.");
define("LangException003b"																,"Vous voulez visualiser un oculaire, bien que vous n'en avez pas s�lectionn�. Veuillez contacter les d�veloppeurs avec ce message.");
define("LangException004"																	,"Vous voulez modifier un oculaire, mais celui-ci ne vous appartient pas. Veuillez contacter les d�veloppeurs avec ce message.");
define("LangException005"																	,"Vous voulez modifier un filtre bien que vous n'en avez pas s�lectionn�. Veuillez contacter les d�veloppeurs avec ce message.");
define("LangException005b"																,"Vous voulez visualiser un filtre bien que vous n'en avez pas s�lectionn�. Veuillez contacter les d�veloppeurs avec ce message.");
define("LangException006"																	,"Vous voulez modifier un filtre mais celui-ci n'est pas le votre. Veuillez contacter les d�veloppeurs avec ce message.");
define("LangException007"																	,"Vous voulez modifier un instrument bien que vous n'en avez pas s�lectionn�. Veuillez contacter les d�veloppeurs avec ce message.");
define("LangException007b"																,"Vous voulez voir un instrument bien que vous n'en avez pas s�lectionn�. Veuillez contacter les d�veloppeurs avec ce message.");
define("LangException008"																	,"Vous voulez modifier un instrument mais celui-ci n'est pas le votre. Veuillez contacter les d�veloppeurs avec ce message.");
define("LangException009"																	,"Vous voulez modifier une lentille Barlow bien que vous n'en avez pas s�lectionn�e. Veuillez contacter les d�veloppeurs avec ce message.");
define("LangException009b"																,"Vous voulez visualiser une lentille Barlow bien que vous n'en avez pas s�lectionn�e. Veuillez contacter les d�veloppeurs avec ce message.");
define("LangException010"																	,"Vous voulez modifier une lentille Barlow mais celle ci n'est pas la votre. Veuillez contacter les d�veloppeurs avec ce message.");
define("LangException011"																	,"Vous voulez modifier un endroit bien que vous n'en avez pas s�lectionn�. Veuillez contacter les d�veloppeurs avec ce message.");
define("LangException011b"																,"Vous voulez visualiser un endroit bien que vous n'en avez pas s�lectionn�. Veuillez contacter les d�veloppeurs avec ce message.");
define("LangException012"																	,"Vous voulez modifier un endroit mais celui-ci n'est pas le votre. Veuillez contacter les d�veloppeurs avec ce message.");
define("LangException013"																	,"Vous voulez chercher un endroit bien que vous n'en avez pas s�lectionn�.");
define("LangException014"																	,"Vous voulez chercher un endroit bien que vous n'avez pas s�lectionn� de pays.");
define("LangException015b"																,"Vous voulez modifier un observateur bien que vous n'en avez pas s�lectionn�. Veuillez contacter les d�veloppeurs avec ce message.");
define("LangException016"																	,"Vous voulez visualiser un objet bien que vous n'en avez pas s�lectionn�. Veuillez contacter les d�veloppeurs avec ce message.");
define("LangException016b"																,"Vous voulez modifier un objet mais celui-ci est inconnu. Veuillez contacter les d�veloppeurs avec ce message.");

define("LangCounter"																			,"Compteur");
define("LangMenuExpand"																		,"D�rouler le menu");
...
define("LangWelcome2"																			,"Vous&nbsp;�tes&nbsp;rentr�&nbsp;comme&nbsp;");
define("LangWelcome3"																			,"Vous&nbsp;n'�tes&nbsp;pas&nbsp;rentr�");
...
define("LangAccountSubscribed1"														,"Votre compte Deepskylog est cr�e. ");  // javascript strings, please no html encoding
define("LangAccountSubscribed2"														,"Un de nos d�veloppeurs validera votre compte au plus vite. ");  // javascript strings, please no html encoding
...
define("LangAccountSubscribed6"														,"Exceptionnellement, tous les d�veloppeurs sont en observation astronomique ");  // javascript strings, please no html encoding
define("LangAccountSubscribed7"														,"pendant une semaine. Normalement un backup est pr�vu pendant cette p�riode. ");  // javascript strings, please no html encoding
define("LangAccountSubscribed8"														,"Si votre compte n'est pas valid� dans les 24 heures, veuillez envoyer un email ");  // javascript strings, please no html encoding
define("LangAccountSubscribed9"														,"aux d�veloppeurs de deepskylog.be pour en �tre sur.");  // javascript strings, please no html encoding
...
define("LangShowInterfaceLanguage"												,"Ne montrer que les observations en Fran�ais");
...
define("LangInstructionsNoObjectFound"										,"Pas d'objets correspondants trouv�s pour ");
...
define("LangSearchMenuItem8"															,"Les observations de l'ann�e");
define("LangSearchAllLanguages"														,"Une nouvelle rechrerche dans toutes les languages.");
define("LangSearchDetailPage"															,"Faire une recherche d�taill�e.");
...
define("LangAddEyepieceExisting"													,"S�lectionnez les donn�es de l'oculaire de la liste");
...
define("LangAddLensExisting"															,"rajoutez les donn�es manuellement");
define("LangAddLensFieldManually"													,"Specifiez manuellement les d�tails de la lentille Barlow");
...
define("LangValidateLensMessage1"													,"Cete lentille barlow a �t� enlev�e de votre liste d'�quipements");
...
define("LangAddFilterFieldManually"												,"Specifiez manuellement les d�tails du filtre");
...
define("LangAddSiteField8"																,"Luminosit� typique du ciel");
...
define("LangCheckName"																		,"V�rifiez le nom");
define("LangCheckRA"																			,"V�rifiez les coordonn�es");
define("LangPossibleCandidateObjects"											,"Candidats possibles");
define("LangPossibleCandidateObjectsExplanation"					,"Pri�re de confirmer que l'objet n'est pas pr�sent");
define("LangObjectNotFound"																,"Confirmation");
define("LangNewObjectPhase0"															,"Entrez uniquement un objet qui ne se trouve pas encore dans le syst�me. Veuillez d�abord entrer le nom de l'objet. ".
                            															 "Entrez le catalogue dans la premi�re cellule , le num�ro dans le catalogue dans la deuxi�me cellule (p.ex. M dans la premi�re cellule, 1 dans la deuxi�me cellule). ");
define("LangNewObjectPhase10"															,"V�rifier si le nom n'existe pas d�j� dans la liste ci-dessous. Prenez tout votre temps pour v�rifier vos donn�es. ".
                             															 "Vous pouvez abandonner cette section au cas ou l'objet se trouve dans la liste en cliquant par ex. sur l'objet pour v�rifier si c'est le bon. ".
                             															 "Au cas ou l'objet ne se trouve pas dans la liste vous pouvez continuer � entrer les donn�es en cliquant le bouton 'Confirmation'. Attention: si besoin d�roulez la liste pour voir tous les objets.");
define("LangNewObjectPhase1" 															,"Entrez maintenant les coordonn�es de l'objet: ascension droite et la d�clinaison. ".
                             															 "L'�poque 2000 (J2000) est utilis�e pour nos coordonn�es.");
define("LangNewObjectPhase20"															,"V�rifier maintenant  si le nom n'existe pas d�j� dans la liste ci-dessous, en se basant sur les coordonn�es. Prenez votre temps pour v�rifier les entr�es. ".
                             															 "Vous pouvez abandonner cette section au cas ou l'objet se trouve dans la liste en cliquant par ex. sur l'objet pour v�rifier si c'est le bon. ".
                             															 "Au cas ou l'objet ne se trouve pas dans la liste vous pouvez continuer �entrer les donn�es en cliquant le bouton 'Confirmation'. Attention: si besoin d�roulez la liste pour voir tous les objets.");
define("LangNewObjectPhase2" 															,"Continuer maintenant � entrer les d�tails de l'objet. ".
                             															 "Lorsque vous avez termin�, confirmez en utilisant le bouton 'Rajouter l'objet' ci-dessus.");
...
define("LangListQueryObjectsMessage4"											,"Rajoutez&nbsp;tous&nbsp;les&nbsp;r�sultats&nbsp;de&nbsp;la&nbsp;liste&nbsp;");
...
define("LangViewObservationField38"												,"Tachet�");
...
define("LangValidateEyepieceMessage6"											,"L'oculaire est supprim� de votre liste d'�quipements.");

//control/validate_filter

define("LangValidateFilterMessage2"												,"Le filtre est ajout� � votre liste d'�quipements");
define("LangValidateFilterMessage5"												,"Le filtre est modifi� dans votre liste d'�quipements");
define("LangValidateFilterMessage6"												,"Le filtre est supprim� de votre liste d'�quipements");
...
define("LangValidateLocationMessage3"											,"L'endroit a �t� enlev� de votre liste");
...
define("LangValidateInstrumentMessage3"										,"L'instrument a &eacute;t&eacute; rajout&eacute; dans votre liste d'�quipement");
define("LangValidateInstrumentMessage4"										,"L'instrument a &eacute;t&eacute; adapt&eacute; dans votre liste d'�quipement");
define("LangValidateInstrumentMessage5"										,"L'instrument a �t� enlev� de votre liste d'�quipements");
...
define("LangObservationQueryError1b"											,"Il n'y a pas d'objet avec ces sp�cifications.");
...
define("LangCSVMessage3"																	,"<b><i> 1-Objet; 2-Observateur; 3-Date; 4-TU; 5-Endroit; 6-Instrument; 7-Oculaire; 8-Filtre; 9-Lentille; 10-Seeing; 11-LimMag ou SQM comme vous voulez; 12-Visibilit&eacute;; 13-Langue; 14-Description</i></b>");
define("LangCSVMessage4"																	,"<b>Attention!</b> Contrairement � la version 3.3 et pr�c�dentes, le fichier <b>ne peut plus</b> contenir <u>une ligne de t�te</u>, 
                           																	la premi�re ligne contient directement des observations dans le format mentionn�, par exemple: <br /><br />
...
define("LangCSVMessage5"																	,"Attention!<p>Les instruments, les endroits, les oculaires, filters et les objets dans le fichier csv doivent d&eacute;j&agrave; &ecirc;tre connus par DeepskyLog. 
                           																	...
                           																	L'information manquante ou erroneuse doit &ecirc;tre remplie &agrave; la main ou adapt�e jusqu'au moment o&ugrave; il n'y a plus de messages d'erreur.<p>&nbsp;</p>
...
define("LangCSVMessage8"																	,"Observations rajout�es");
define("LangCSVMessage9"																	,"; observations avec des probl�mes (rejet�es)");
define("LangCSVMessage10"																	,"; observations d�j� pr�sentes (ne sont pas reprises)");
define("LangCSVError0"																		,"L'import csv des observations a �t� arr�t�");
...
define("LangCSVError10"																		,"Les observations n'ont pas �t� enregistr�es.<br />Il faut d'abord r�soudre les probl�mes mentionn�s pour ensuite ");
define("LangCSVError10a"																	,"r�importer");
define("LangCSVError10b"																	," le fichier. Vous pouvez limiter le r�import aux observations fausses, ou vous pouvez les r�importer tous. Les observations correctes seront reconnues et ne seront pas r�import�es une deuxi�me fois.");
...
define("LangXMLTitle"																			,"Importez les observations � partir d'un fichier XML");
define("LangXMLMessage1"																	,"Ce formulaire vous donne la possibilit� d'ajouter diff�rentes observations en utilisant un fichier OpenAstonomyLog XML.");
define("LangXMLMessage2"																	,"De cette fa�on, vous pouvez �changer facilement et rapidement des observations entre diff�rentes applications qui supportent le format OpenAstonomyLog XML (comme <a href=\"http://observation.sourceforge.net\">Observation Manager</a>, <a href=\"http://www.eyeandtelescope.com/\">Eye&amp;Telescope</a>), ...");
define("LangXMLMessage3"																	,"Informations: uniquement les observations avec votre nom (pr�nom et nom) seront ajout�es. Les observations qui sont d�j� disponibles dans deepskylog ne seront pas import�es une seconde fois.");
...
define("LangValidateXMLMessage"														,"L'importation du fichier XML est r�ussie!");
...
define("LangVisibility5"																	,"Objet difficilement visible en vision p�r�f�rique");
...
define("LangSelectedObservationsTitle3"										,"Aper&ccedil;u des observations de la derni�re ann�e");
define("LangSelectedObservationsSelectedLanguagesIndication"	
 																													,"languages s�lection�es");
define("LangSelectedObservationsAllLanguagesIndication"		,"toutes les languages");
 
// lib/objects
define("LangNewPlaceInList"																,"Pri�re de rentrer la nouvelle position dans la liste.");

// lib/observations
define("LangObservationDeleted"														,"L'observation a �t� effac�e");
...
define("LangPDFMessage19"																	,"Pr�par� pour ");
...
define("LangNumberOfRecordsPerPages"											,"Nombre de r�sultats par page");
define("LangAskForDesiredNumberOfItemsPerPage"						,"Donnez le nombre voulu de r�sultats par page");
define("LangCaptionAskForDesiredNumberOfItemsPerPage"			,"Cliquez pour changer le nombre de r�sultats par page.");
...
//Cluster types
$ClusterTypeA						="Riche, peu concentr�, luminosit� diff�rente, d�tach�";
$ClusterTypeB						="Peu concentr�, luminosit� diff�rente, d�tach�";
$ClusterTypeC						="Pauvre, peu concentr�, luminosit� diff�rente, d�tach�";
$ClusterTypeD						="Riche, concentr�, d�tach�";
$ClusterTypeE						="Riche, peu concentr�, luminosit� uniforme, d�tach�";
$ClusterTypeF						="Uniquement m�me couleur ou luminosit�, pas d�tach�";
$ClusterTypeG						="Gros agrandissement, amas compacte, riche, faible";
$ClusterTypeH						="Tr�s pauvre, pas du tout d�tach�";
...
$Visibility5						="Objet difficilement visible en vision p�r�f�rique";
