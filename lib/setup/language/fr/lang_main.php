...
define("LangCSVMessage8", " observations sont rajoutées, ");
define("LangCSVMessage9", " observations avec des problèems sont rejetées, ");
define("LangCSVMessage10", " observations étaient déjà présentes et ne sont pas reprises.");
...
define("LangCSVError10b", " le fichier. Vous pouvez limiter le réimport aux observations fausses, ou vous pouvez les réimporter tous. Les observations correctes seront reconnues et ne seront pas réimportées une deuxième fois. Vous pouvez consulter la liste erroneuse en cliquant ");
