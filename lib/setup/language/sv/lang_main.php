...
define("LangCSVMessage4"																	,"The file may <strong>not</strong> contain <u>a header line</u>,
...
define("LangCSVListMessage1"															,"This form gives you the possibility to add different objects at once using a CSV file (comma separated value). The form makes ot also possible to easily add objects from another database to your DeepskyLog list.");
