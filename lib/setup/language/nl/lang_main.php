...
define("LangCSVError10", "Enkel de foutloze waarnemingen ingelezen.<br />Je dient eerst de bovenstaande zaken op te lossen om dan opnieuw de <a href=\"".$baseURL."index.php?indexAction=add_csv\">import</a> uit te voeren. Je mag dit doen met enkel de foute waarnemingen, of alle waarnemingen. Reeds ingelezen waarnemingen worden herkend en geen tweede keer genoteerd. Voor een lijst met de foute waarnemingen, klik ");
