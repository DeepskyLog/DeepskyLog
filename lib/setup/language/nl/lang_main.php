...
define("LangpdfseriesExplain5"  ,"U kan elke set opslaan en eventueel met een pdf samenvoegprogramma samenstellen tot ��n catalogus-atlas.");
define("LangpdfseriesExplain5b" ,"Als u alles in ��n keer aanmaakt, reken dan op een lange verwerkingstijd, tot 30 seconden of meer per oject. Let op: deze optie is beschikbaar in alle browsers behalve Microsoft Internet Explorer.");
