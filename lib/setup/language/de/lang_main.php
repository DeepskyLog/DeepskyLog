...
// Quickpick menu
define("LangQuickPickHelp", "Geben Sie den Namen des Objektes an. Zuerst der Katalogname, gefolgt von einem Leerzeichen und der Katalognummer (z.B.: 'NGC&nbsp;7000', 'Mel 20' oder auch 'Ring&nbsp;Nebel').");
...
define("LangLoginMenuTitle", "Anmelden oder ");
...
define("LangExecuteQueryObjectsMessage4", "Download pdf-Datei");
define("LangExecuteQueryObjectsMessage4b", "Download Namen pdf-Datei");
define("LangExecuteQueryObjectsMessage4c", "Download Detail pdf-Datei");
define("LangExecuteQueryObjectsMessage5", "Exportiere die Beobachtungen in eine CSV Datei");
define("LangExecuteQueryObjectsMessage6", "Exportiere die Objekte in eine CSV Datei");
...
define("LangCSVMessage2", "Die CSV Datei sollte mit folgender Zeile starten: <b>(NEW FORMAT!!!)</b>");
define("LangCSVMessage3", "Objekt;Beobachter;Datum;UT;Beobachtungsplatz;Beobachtungsger&auml;t;Okular;Filter;Linse;Seeing;Schw&auml;chsterStern;Sichtbarkeit;Sprache;Beschreibung");
define("LangCSVMessage4", "Gefolgt von den eigentlichen Beobachtungen im selben Format, z.B.: <br><br>Objekt;Beobachter;Datum;UT;Beobachtungsplatz;Beobachtungsger&auml;t;Okular;Filter;Linse;Seeing;Schw&auml;chsterStern;Sichtbarkeit;Sprache;Beschreibung<br>NGC 2392;Max Mustermann;21-01-2005;20:45;Wehrheim;TolleR&ouml;hre10\";31mm Nagler;Lumicon O-III filter;Televue 2x Barlow;2;4.0;3;de;Sch&ouml;ner Planetarische Nebel mit sehr hellem zentral Stern!<br>M 35;Max Mustermann;21-01-2005;20:53;Wehrheim;TolleR&ouml;hre10\";;;;2;4.0;1;de;Circa 30 Mitglieder mit deutlichen Strukturen im Haufen.<br>...<br><br>Seeing sollte als Wert zwischen 1 und 5 angegeben werden (1=Exzellent, 2=Gut, 3=Moderat, 4=Schwach, 5=Sehr schwach).<br>Sichtbarkeit sollte als Wert zwischen 1 und 7 angegeben werden (1=Sehr einfaches, auff&auml;lliges Objekt im Okular, 2=Objekt bei direktem Beobachten gut zu sehen, 3=Objekt bei direktem Beobachten zu sehen, 4=Indirektes Beobachten ist n&ouml;tig, um das Objekt zu sehen, 5=Objekt bei indirektem Beobachten gerade noch wahrnehmbar, 6=Sichtung des Objektes sehr fraglich, 7=Objekt sicher nicht zu sehen).<br>Wenn eine Beobachtung mit dem blo&szlig;en Auge erfolgte, geben Sie bitte als Beobachtungsger&auml;t 'Naked Eye' an.<br>Sprache sollte der zweistellige ISO-Code der Sprache sein, in der die Beschreibung geschrieben ist (en f&uuml;r Englisch, de f&uuml;r Deutsch, ...)");
...
define("LangCSVError10", "Es wurden keine Beobachtungen eingelesen.<br />Bitte reparieren Sie die Eintr&auml;ge aus der o.g. Liste. Starten Sie dann den kompletten <a href=\"".$baseURL."index.php?indexAction=add_csv\">reimport</a> der CSV-Datei noch einmal an.");
...
define("LangCSVListMessage5", "Achtung!<p>Die Objekte in der CSV Datei sollten bereits in der DeepskyLog Datenbank bekannt sein. Wenn dies nicht der Fall ist, erscheint eine Fehlermeldung und keines der Objekte wird imporiert! Die unbekannten Objekte sollten vorher manuell hinzugef&uuml;gt werden, sollange bis keine Fehler mehr beim Import erscheinen. Wenn der Import erfolgreich ist, erscheinen die neuen Objekte in Ihrer Liste. Dublikate werden eliminiert beim Import!");
...
define("LangCSVObjectMessage1", "Diese Eingabemaske erlaubt Ihnen mehrere Objekte auf einmal einzugeben, indem Sie eine CSV Datei importiren (comma seperated value Datei). Dies beschleunigt das Hochladen ihrer Objekte.");
define("LangCSVObjectMessage2", "Dies CSV Datei sollte folgenden Aufbau haben, wenn sie die Nomenklatur von Objekten betrifft: </b>");
...
define("LangSelectedObservationsSelectedLanguagesIndication", "Ausgew&auml;hlte Sprachen");
