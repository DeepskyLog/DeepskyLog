<?php //EN
define('LangAccomplishmentsH400Bronze', "Bronze Herschel 400 certificat! You observed 25 Herschel 400 objects!");
define('LangAccomplishmentsH400Silver', "Silver Herschel 400 certificat! You observed 50 Herschel 400 objects!");
define('LangAccomplishmentsH400Gold', "Golden Herschel 400 certificat! You observed 100 Herschel 400 objects!");
define('LangAccomplishmentsH400Diamond', "Diamond Herschel 400 certificat! You observed 200 Herschel 400 objects!");
define('LangAccomplishmentsH400Platina', "Platinum Herschel 400 certificat! You observed all 400 Herschel 400 objects!");
define('LangH400BronzeToAccomplish'   , "Observe at least 25 Herschel 400 objects to get this certificat!");
define('LangH400SilverToAccomplish'   , "Observe at least 50 Herschel 400 objects to get this certificat!");
define('LangH400GoldToAccomplish'     , "Observe at least 100 Herschel 400 objects to get this certificat!");
define('LangH400DiamondToAccomplish'     , "Observe at least 200 Herschel 400 objects to get this certificat!");
define('LangH400PlatinaToAccomplish'     , "Observe all 400 Herschel 400 objects to get this certificat!");
define('LangAccomplishmentsH400BronzeDr', "Bronze Herschel 400 drawing-certificat! You drawed 25 Herschel 400 objects!");
define('LangAccomplishmentsH400SilverDr', "Silver Herschel 400 drawing-certificat! You drawed 50 Herschel 400 objects!");
define('LangAccomplishmentsH400GoldDr'  , "Golden Herschel 400 drawing-certificat! You drawed 100 Herschel 400 objects!");
define('LangAccomplishmentsH400DiamondDr'  , "Diamond Herschel 400 drawing-certificat! You drawed 200 Herschel 400 objects!");
define('LangAccomplishmentsH400PlatinaDr'  , "Platinum Herschel 400 drawing-certificat! You drawed all 400 Herschel 400 objects!");
define('LangH400BronzeToAccomplishDr'   , "Draw at least 25 Herschel 400 objects to get this certificat!");
define('LangH400SilverToAccomplishDr'   , "Draw at least 50 Herschel 400 objects to get this certificat!");
define('LangH400GoldToAccomplishDr'     , "Draw at least 100 Herschel 400 objects to get this certificat!");
define('LangH400DiamondToAccomplishDr'     , "Draw at least 200 Herschel 400 objects to get this certificat!");
define('LangH400PlatinaToAccomplishDr'     , "Draw all 400 Herschel 400 objects to get this certificat!");
define('LangAccomplishmentsHIIBronze', "Bronze Herschel II certificat! You observed 25 Herschel II objects!");
define('LangAccomplishmentsHIISilver', "Silver Herschel II certificat! You observed 50 Herschel II objects!");
define('LangAccomplishmentsHIIGold', "Golden Herschel II certificat! You observed 100 Herschel II objects!");
define('LangAccomplishmentsHIIDiamond', "Diamond Herschel II certificat! You observed 200 Herschel II objects!");
define('LangAccomplishmentsHIIPlatina', "Platinum Herschel II certificat! You observed all II Herschel II objects!");
define('LangHIIBronzeToAccomplish'   , "Observe at least 25 Herschel II objects to get this certificat!");
define('LangHIISilverToAccomplish'   , "Observe at least 50 Herschel II objects to get this certificat!");
define('LangHIIGoldToAccomplish'     , "Observe at least 100 Herschel II objects to get this certificat!");
define('LangHIIDiamondToAccomplish'     , "Observe at least 200 Herschel II objects to get this certificat!");
define('LangHIIPlatinaToAccomplish'     , "Observe all II Herschel II objects to get this certificat!");
define('LangAccomplishmentsHIIBronzeDr', "Bronze Herschel II drawing-certificat! You drawed 25 Herschel II objects!");
define('LangAccomplishmentsHIISilverDr', "Silver Herschel II drawing-certificat! You drawed 50 Herschel II objects!");
define('LangAccomplishmentsHIIGoldDr'  , "Golden Herschel II drawing-certificat! You drawed 100 Herschel II objects!");
define('LangAccomplishmentsHIIDiamondDr'  , "Diamond Herschel II drawing-certificat! You drawed 200 Herschel II objects!");
define('LangAccomplishmentsHIIPlatinaDr'  , "Platinum Herschel II drawing-certificat! You drawed all II Herschel II objects!");
define('LangHIIBronzeToAccomplishDr'   , "Draw at least 25 Herschel II objects to get this certificat!");
define('LangHIISilverToAccomplishDr'   , "Draw at least 50 Herschel II objects to get this certificat!");
define('LangHIIGoldToAccomplishDr'     , "Draw at least 100 Herschel II objects to get this certificat!");
define('LangHIIDiamondToAccomplishDr'     , "Draw at least 200 Herschel II objects to get this certificat!");
...
define('LangAtlasButton9'               ,"Detail - Whole atlas");
define('LangAtlasGenerateCompleteAtlas' ,'Generate the whole atlas (not available in Internet Explorer)');
define('LangAtlasGenerateOnePage'       ,'Generate a page');

define('LangAtlasGenerationTimes'       ,"Generation times may take from 20 minutes (Overview A4) up to several hours (Lookup A3).");
...
define("LangSearchMenuItem15"           ,"Forms");
...
define('LangDownloadFormsIntro07'       ,'If you want to jot down multiple brief observation notes on one piece of paper.');
...
define("LangDeleteSessionButton"    		,"Delete session");
...
define("LangpdfseriesExplain5b" ,"If you choose to make all objects in one pass, please remember that each object can take up to 30 seconds or more to generate. Attention: this option is available in all browsers except for Microsoft Internet Explorer.");
...
define("profilefovmagnitude"                            ,"Atlas standard object FoVs:");
define("profilefovmagnitudeselect"                      ,"Overview / Lookup / Detail");
...
$atlasPageText=array(
       ...
       'atlasPageDone'                                   =>'Press H for help - A for abbreviations - P for printing - O for Overview chart - Z for Lookup chart - D for Detail chart',
...
define("LangException002c"																,"You need to be logged in to add an object.");
...
//ToList
define("LangList"                                         ,"The list");
define("LangToListList"																		,"The list \"");
define("LangToListActivation1"														,"\" is activated");
...
define("LangToListObjectRemoved"													," has been removed from the list ");
...
define("LangCSVListError1"																,"Errors have occured during the import.");
define("LangCSVListError2"																,"Unknown objects:");
define("LangToListListBy"																	,"List by: ");

// List menu
define("LangListManage"																		,"Lists");
...
define("LangMailtoLink"																		,"<a href=\"mailto:&#100;&#101;v&#101;lop&#101;rs&#64;&#100;&#101;&#101;pskylog.&#98;&#101;\">Ask question</a>");
...
define("LangAddSiteField8"																,"Sky Quality Meter (SQM) value");
define("LangAddSiteField9"																,"Bortle Scale");
define("LangAddSiteField10", "Use value from lightpollutionmap.info");
...
define("LangNewObjectPhase0"															,"Only enter new objects that are not in the system yet. First, you have to enter the name of the object. ".
...
define("LangOverviewObjectsHeader10"											,"Size");
...
define("LangDrawnByMe"																		,"Only objects that have been drawn by me");
define("LangSeenSomeoneElse"															,"Already seen by someone else but not by me");
define("LangSeenByMeOrSomeoneElse"												,"Only objects that have already been seen");
define("LangNotSeenByMeOrNotSeenAtAll"										,"Only objects that haven't been seen by me");
define("LangNotDrawnByMe"							              			,"Only objects that haven't been drawn by me");
define("LangNotSeen"																			,"Only objects that haven't been seen");
define("LangNotDrawn"																			,"Only objects that haven't been drawn");
define("LangDrawn"													   						,"Only objects that have been drawn");
...
define("LangViewObjectObservations"												,"All observations");
define("LangViewObjectViewNearbyObject"										,"Nearby objects");
define("LangViewObjectAddObservation"											,"New observation");
define("LangViewObjectInexistant"													,"This object doesn't exist!");
define("LangViewObjectNearbyObjects"											,"nearby objects");
define("LangViewObjectNearbyObject"												,"nearby object");
...
define("LangViewObserverName"															,"Last Name");
define("LangViewObserverFirstName"												,"First Name");
define("LangViewObserverRole"															,"Role");
define("LangViewObserverLastLogin"                        ,"Last login");
define("LangViewObserverinstrumentCount"                  ,"Number of instruments");
...
define("LangCSVListMessage1"															,"This form gives you the possibility to add different objects at once using a CSV file (comma separated value). The form makes it also possible to easily add objects from another database to your DeepskyLog list.");
...
define("LangCSVListMessage5a"															,"The objects in the CSV file should be known already by DeepskyLog. When this is not the case, a error message will appear and no objects will be added at all!");
define("LangCSVListMessage5b"															,"The non existing objects should be added manually until no error messages are shown. When everything goes fine, the added objects will be shown in your list.");
...
// lib/observations
define("LangObservationDeleted"														,"The observation has been removed");
...
define("LangNumberOfRecords1"															,"result");
