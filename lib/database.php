...
{ public function __constructor();
  public function newlogin();      // Should be removed when code leanup finishes, code should go into the constructor
	public function login();         // Should be removed when code leanup finishes
	public function logout();        // Should be removed when code leanup finishes
