...
class Contrast
{
 ...
 // This function should not be used. Only needed for the calculations
 function calcSubroutine($x, $SBObj, $minObjArcmin, $maxObjArcmin, $maxLog, $logObjContrast)
 {
 ...
 function calculateSkyBackgroundFromLimitingMagnitude($limMag)
 {
  
   return ((21.58 - 5 * log10(pow(10, (1.586 - $limMag / 5.0)) - 1.0)));
 }

 function calculateLimitingMagnitudeFromSkyBackground($initBB)
 {
