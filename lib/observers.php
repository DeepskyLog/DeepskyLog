...
class Observers {
	...
	public function validateObserver() 	// validateObserver validates the user with the given id and gives the user the given role
	{
		...
		$objMessages->sendMessage ( "DeepskyLog", $id, LangMessageWelcomeSubject . $this->getObserverProperty ( $id, 'firstname' ) . "!", LangMessageWelcomeSubject . $this->getObserverProperty ( $id, 'firstname' ) . "!<br /><br />" . LangMessageWelcome1 . "<a href=\"" . $baseURL . "index.php?indexAction=add_instrument\">" . LangMessageWelcome2 . "<a href=\"" . $baseURL . "index.php?indexAction=add_site\">" . LangMessageWelcome3 . "<a href=\"" . $baseURL . "index.php?indexAction=change_account\">" . LangMessageWelcome4 );
