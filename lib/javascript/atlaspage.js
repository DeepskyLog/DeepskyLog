...
{ astroObjectsArr=new Array();
  canvasDrawNamedLabel(coordBkGroundColor,coordColor,atlasPageStarsFetching+' 8',5,canvasDimensionYpx-20,300,16,'left','infoline');
  //astroGetObjects(); // Chains to drawing automatically
  astroGetStarsMagnitude(-2,8);
}
...
{ //alert(toMagnitude+' '+from+' '+to);
  ...
  { if(astroObjectsArr[i]["type"]=='AASTAR1')
    ...
    else if(astroObjectsArr[i]["type"]=='AA1STAR')
  ...
  {	newtoMagnitude=toMagnitude+1;
    canvasreDrawNamedLabel(coordBkGroundColor,coordColor,atlasPageObjectsFetching+'&nbsp;'+newtoMagnitude,5,canvasDimensionYpx-20,300,16,'left','infoline');
...
{ //alert(toMagnitude+' '+from+' '+to);
  ...
  {	newtoMagnitude=toMagnitude+1;
    canvasreDrawNamedLabel(coordBkGroundColor,coordColor,atlasPageStarsFetching+'&nbsp;'+newtoMagnitude,5,canvasDimensionYpx-20,300,16,'left','infoline');
    astroGetStarsMagnitude(toMagnitude,newtoMagnitude);
    jg.paint();
  }
  else
  { canvasreDrawNamedLabel(coordBkGroundColor,coordColor,atlasPageObjectsFetching+'&nbsp;8',5,canvasDimensionYpx-20,300,16,'left','infoline');
    //astroGetObjects(); // Chains to drawing automatically
    astroGetObjectsMagnitude(-2,8);
  }
}
