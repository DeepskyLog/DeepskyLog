...
{ var ret='';
  ...
  { ret ="<span style='text-decoration:underline;'>"+atlasPageObjectTxt+":</span> "+getAstroObjectValue(object,"name")+"<br /> ";
    ret+=atlasPageConsTxt+": "+getAstroObjectValue(object,"con")+"<br /> ";
    ret+=atlasPageTypeTxt+": "+getAstroObjectValue(object,"type")+"<br /> ";
    ret+=atlasPageSeenTxt+": "+getAstroObjectValue(object,"seen")+"<br /> ";
    ret+=(((mag =getAstroObjectValue(object,"mag" ))==99.9)?"":atlasPageMagnTxt)+(((subr=getAstroObjectValue(object,"subr"))==99.9)?"":"/"+atlasPageSubrTxt)+((mag==99.9)?"":": ")+((mag==99.9)?"":mag)+((subr==99.9)?"":"/"+subr)+((mag==99.9)?"":"<br /> ");
    ret+=(( (diam1=(Math.round(getAstroObjectValue(object,"diam1")/6)/10))==0)?"":atlasPageDiamTxt+": "+diam1+
    ...
    ret+=(((descr=getAstroObjectValue(object,"description"))=="")?"":"<hr />"+htmlentities(descr)+"<br /> ");
  }
  return ret;
}
...
{ canvasRedraw();
  ...
  jg.paint();
  //document.getElementById("atlasPageDiv").setFocus();
}
