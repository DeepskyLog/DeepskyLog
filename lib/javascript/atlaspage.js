...
{ if(diam2==0) diam2=diam1;
  gridDrawRectangleCWHObject(Lhr,Ddeg,diam1,diam1,pa,nm,seen,nm,object);
}
...
{ jg.setColor(starColor);
  gridDrawEllipseTiltObject(Lhr,Ddeg,(diam),(diam),0,nm,seen,object);
}
...
{ jg.setFont("verdana,geneva,helvetica,sans-serif", "10px", Font.PLAIN);
  ...
  { if(getAstroObjectValue(i,"type")=='AASTAR1')
    { name=getAstroObjectValue(i,"nameBayer")+'&nbsp;'+getAstroObjectValue(i,"nameBayer2")+'&nbsp;'; 
      ...
      astroDrawDStarxObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"mag"),getAstroObjectValue(i,"name"),i);
      ...
      astroDrawDRKNBObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
...
{ var ret='';
  ...
  { ret ="<span style='text-decoration:underline;'>Object:</span> "+getAstroObjectValue(object,"name")+"<br /> ";
    ret+="Type: "+getAstroObjectValue(object,"type")+"<br /> ";
    ret+="Seen: "+getAstroObjectValue(object,"seen")+"<br /> ";
    ret+=(((mag =getAstroObjectValue(object,"mag" ))==99.9)?"":"Magn: "+mag+"<br /> ");
    ret+=(((subr=getAstroObjectValue(object,"subr"))==99.9)?"":"Subr: "+subr+"<br /> ");
    ret+=(( (diam1=(Math.round(getAstroObjectValue(object,"diam1")/6)/10))==0)?"":"Diam: "+diam1+
    		 ((((diam2=(Math.round(getAstroObjectValue(object,"diam2")/6)/10))==0)||(diam2==diam1))?"":"x"+diam2)+"'<br /> ");
    ret+=(((pa=getAstroObjectValue(object,"pa"))==999)?"":"pa: "+pa+"&deg;<br /> ");
    ret+=(((descr=getAstroObjectValue(object,"description"))=="")?"":htmlentities(descr)+"<br /> ");
  }
  return ret;
}
...
{ divInit('myDiv');
  ...
  atlasRedraw();
  jg.paint();
  document.getElementById('myDiv1').style.filter='alpha(opacity=80)';
  document.getElementById('myDiv1').style.opacity=0.8;
}
...
{ if(event.keyCode==76)
	  labelsOn=!(labelsOn);
  //if(labelsOn) alert('Labels On'); else alert('Labels Off');
  atlasRedraw();
}
...
{ x=event.clientX;
  y=event.clientY+1;
	...
	jg.paint();
  if(((x!=myDiv1x)||(y!=myDiv1y))&&((document.getElementById("myDiv1").style.left!='0px')||(document.getElementById("myDiv1").style.top!='0px')))
  {	document.getElementById("myDiv1").style.left='0px';
    document.getElementById("myDiv1").style.top='0px';
    document.getElementById("myDiv1").style.width='0px';
    document.getElementById("myDiv1").style.height='0px';
...
{ myDiv1x=event.clientX;
  myDiv1y=event.clientY+1;
  if((myDiv1x+185-div5Left)>div5Width)
    document.getElementById("myDiv1").style.left=(myDiv1x-185-div5Left)+'px';  
  else	
    document.getElementById("myDiv1").style.left=(myDiv1x+10-div5Left)+'px';
  if((myDiv1y+132-div5Top)>div5Height)
  	document.getElementById("myDiv1").style.top=(myDiv1y-132-div5Top)+'px';  
  else	
  	document.getElementById("myDiv1").style.top=(myDiv1y+2-div5Top)+'px';
  document.getElementById("myDiv1").style.width="175px";
  document.getElementById("myDiv1").style.height="130px";
  document.getElementById("myDiv1").innerHTML=astroObjectDetails(object);
}
