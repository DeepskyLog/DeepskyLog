...
//function astroSetObject(objectType,x,y,diam1,diam2,pa,mag,sb,objectname,altnames,seen,lastseendate) Set an astro object
...
{ // Demo data
  ...
  astroSetObject('AA1STAR',14.9, 36.0       ,0,0,0,8, 0,'Mizar','24 UMa','X(4)',   '');
...
{ gridInitScale(atlaspagerahr,atlaspagedecldeg,1/2);
  atlasRedraw();
}
function atlasPageZoom2BtnFn()
{ gridInitScale(atlaspagerahr,atlaspagedecldeg,2/2);
  atlasRedraw();
}
