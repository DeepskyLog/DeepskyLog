...
{ var xmlhttp;
  ...
  { if(xmlhttp.readyState==4)
    { var xmlDoc=xmlhttp.responseXML.documentElement;
      astroStars6=xmlDoc.getElementsByTagName("object");
...
{ var xmlhttp;
  ...
  { if(xmlhttp.readyState==4)
    { var xmlDoc=xmlhttp.responseXML.documentElement;
      astroStars=xmlDoc.getElementsByTagName("object");
...
{  return jg.fillEllipseObject(canvasOffsetXpx+cx-((d+1)>>1),canvasOffsetYpx+canvasDimensionYpx-cy-((d+1)>>1),d,d,                         
