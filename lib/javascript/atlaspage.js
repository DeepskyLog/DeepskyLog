...
{ canvasDrawNamedLabel(coordBkGroundColor,coordColor,"Fetching DS objects...",5,canvasDimensionYpx-5,500,16,'left','infoline');
...
{ jg.setFont("Lucida Console", fontSize1a+"px", Font.PLAIN);
  ...
  */
  canvasreDrawNamedLabel(coordBkGroundColor,coordColor,"Done.",5,canvasDimensionYpx-5,500,16,'left','infoline');
  jg.paint();
}
...
{ canvasDrawStarLegend(canvasOffsetXpx+550, canvasOffsetYpx-5, 1);
  ...
  canvasDrawString((((gridDimensions[gridActualDimension][3])+1)-1), 555, canvasOffsetYpx+canvasDimensionYpx-5)
  canvasDrawStarLegend(canvasOffsetXpx+650, canvasOffsetYpx-5, 3);
  canvasDrawString((((gridDimensions[gridActualDimension][3])+1)-1.5), 605, canvasOffsetYpx+canvasDimensionYpx-5)
  canvasDrawStarLegend(canvasOffsetXpx+700, canvasOffsetYpx-5, 4);
  canvasDrawString((((gridDimensions[gridActualDimension][3])+1)-2), 655, canvasOffsetYpx+canvasDimensionYpx-5)
  canvasDrawStarLegend(canvasOffsetXpx+750, canvasOffsetYpx-5, 5);
  canvasDrawString((((gridDimensions[gridActualDimension][3])+1)-2.5), 705, canvasOffsetYpx+canvasDimensionYpx-5)
  canvasDrawStarLegend(canvasOffsetXpx+800, canvasOffsetYpx-5, 6);
  canvasDrawString((((gridDimensions[gridActualDimension][3])+1)-3), 755, canvasOffsetYpx+canvasDimensionYpx-5)
  canvasDrawStarLegend(canvasOffsetXpx+850, canvasOffsetYpx-5, 7);
  canvasDrawString((((gridDimensions[gridActualDimension][3])+1)-3.5), 805, canvasOffsetYpx+canvasDimensionYpx-5)
  canvasDrawStarLegend(canvasOffsetXpx+900, canvasOffsetYpx-5, 8);
  canvasDrawString((((gridDimensions[gridActualDimension][3])+1)-4), 855, canvasOffsetYpx+canvasDimensionYpx-5)
  canvasDrawStarLegend(canvasOffsetXpx+950, canvasOffsetYpx-5, 9);
  canvasDrawString((((gridDimensions[gridActualDimension][3])+1)-4.5), 905, canvasOffsetYpx+canvasDimensionYpx-5)
  canvasDrawStarLegend(canvasOffsetXpx+1000,canvasOffsetYpx-5,10);
  canvasDrawString((((gridDimensions[gridActualDimension][3])+1)-5), 955, canvasOffsetYpx+canvasDimensionYpx-5)
  canvasDrawStarLegend(canvasOffsetXpx+1050,canvasOffsetYpx-5,11);
  canvasDrawString((((gridDimensions[gridActualDimension][3])+1)-5.5), 1005, canvasOffsetYpx+canvasDimensionYpx-5)
...
{ divInit('atlasPageDiv');
  ...
  atlasRedraw();
  jg.paint();
  document.getElementById('atlasPageDiv1').style.filter='alpha(opacity=80)';
  document.getElementById('atlasPageDiv1').style.opacity=0.8;
  document.getElementById("atlasPageDiv1").style.visibility='hidden';
  document.getElementById('atlasPageDiv2').style.filter='alpha(opacity=80)';
  document.getElementById('atlasPageDiv2').style.opacity=0.8;
...
{ if((event.ctrlKey)&&(event.shiftKey))
  ...
  { if(event.keyCode==37) 
      atlaspagerahr+=(gridSpanL*((event.ctrlKey)?0.1:((event.shiftKey)?0.05:((event.altKey)?0.0025:0.025))));
    if(event.keyCode==39) 
      atlaspagerahr-=(gridSpanL*((event.ctrlKey)?0.1:((event.shiftKey)?0.05:((event.altKey)?0.0025:0.025))));
    if(event.keyCode==38) 
      atlaspagedecldeg+=(gridSpanD*((event.ctrlKey)?1.6:((event.shiftKey)?0.8:((event.altKey)?0.04:0.4))));
    if(event.keyCode==40) 
      atlaspagedecldeg-=(gridSpanD*((event.ctrlKey)?1.6:((event.shiftKey)?0.8:((event.altKey)?0.04:0.4))));
  }
  if(atlaspagerahr<0) atlaspagerahr+=24;
...
{ jg.setFont("Lucida Console", fontSize1a+"px", Font.PLAIN);
  t1 ='FoV: '+(Math.round(gridSpanL*20)/10)+" x "+(Math.round(gridSpanD*20)/10)+"° - ";
  t1+='LM: '+atlasmagnitude+" - ";
  t1+='Stars to magn.: '+starsmagnitude;
  canvasDrawNamedLabel(coordBkGroundColor,coordColor,t1,150,-17,300,16,'left','gridInfo');
}
