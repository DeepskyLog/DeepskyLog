...
{ if((document.activeElement.id=='quickpickobject')||(document.activeElement.id=='deepskylog_id')||(document.activeElement.id=='passwd'))
  ...
  { gridInitScaleFixed(atlaspagerahr,atlaspagedecldeg,18);
    atlasRedraw();
  }
  ...
  { gridInitScaleFixed(atlaspagerahr,atlaspagedecldeg,17);
    atlasRedraw();
  }
  ...
  { gridInitScaleFixed(atlaspagerahr,atlaspagedecldeg,20);
    atlasRedraw();
  }
