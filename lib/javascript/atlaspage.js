...
var atlaspagerahr=0, atlaspagedecldeg=0, atlaspagezoomdeg=7;
...
function astroDrawStarObject(Lhr,Ddeg,mag,object)
{ var d=Math.round((gridActualDimension-(2*mag)-1)*1.5);
  if(d<=1) d=1;
  jg.setColor(starColor);
  gridDrawFilledCirclePx(Lhr,Ddeg,d);
...
{ if(diam2==0) diam2=diam1;
  gridDrawRectangleCWHObject(Lhr,Ddeg,diam1,diam2,pa,nm,seen,nm,object);
}
function astroDrawCLANBObject(Lhr,Ddeg,diam1,diam2,pa,nm,seen,object)
{ if(diam2==0) diam2=diam1;
  gridDrawRectangleCWH(Lhr,Ddeg,diam1,diam2,pa,'',seen);
...
{ if(diam2==0) diam2=diam1;
  gridDrawRectangleCWHObject(Lhr,Ddeg,diam1,diam2,pa,nm,seen,object);
}
...
{ for(var i=0;(i<astroObjects.length);i++)
  { //if(i==73) alert('i: '+i+' tot: '+getAstroObjectValue(i,"type"));
    ...
    if(getAstroObjectValue(i,"type")=='AASTAR1')
      ...
      astroDrawStarObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"mag"),(getAstroObjectValue(i,"name")));
    else if(getAstroObjectValue(i,"type")=='AA2STAR')
      astroDrawDStarObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"mag"),(getAstroObjectValue(i,"name")));
      ...
      astroDrawOCObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),(getAstroObjectValue(i,"name")));
    else if(getAstroObjectValue(i,"type")=='GALXY')
      astroDrawGXObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),(getAstroObjectValue(i,"name")));
    else if(getAstroObjectValue(i,"type")=='BRTNB')
      astroDrawBRTNBObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),(getAstroObjectValue(i,"name")));
    else if(getAstroObjectValue(i,"type")=='CLANB')
      astroDrawCLANBObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),(getAstroObjectValue(i,"name")));
    else if(getAstroObjectValue(i,"type")=='DRKNB')
      astroDrawDRKNBObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),(getAstroObjectValue(i,"name")));
    else if(getAstroObjectValue(i,"type")=='HII')
      astroDrawHIIObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),(getAstroObjectValue(i,"name")));
...
{ myDiv1x=event.clientX;
  ...
  document.getElementById("myDiv1").style.left=(myDiv1x+2-div5Left)+'px';
  document.getElementById("myDiv1").style.top=(myDiv1y+2-div5Top)+'px';
  document.getElementById("myDiv1").style.width="100px";
  document.getElementById("myDiv1").style.height="100px";
  document.getElementById("myDiv1").innerHTML=object+' Test<br /> '+(x+2)+'px '+y+'px';
}
...
{	angle=-angle;
  jg.drawEllipseTiltLimited(canvasOffsetXpx+cx,canvasOffsetYpx+canvasDimensionYpx-cy,w,h,angle,canvasOffsetXpx+gridOffsetXpx,canvasOffsetXpx+gridOffsetXpx+gridWidthXpx,canvasOffsetYpx+gridOffsetYpx+gridHeightYpx,canvasOffsetYpx+gridOffsetYpx,name,seen,object);
}
