...
{ canvasDrawNamedLabel(coordBkGroundColor,coordColor,atlasPageFetching,5,canvasDimensionYpx-5,500,16,'left','infoline');
  astroGetObjects(); // Chains to drawing automatically
//astroGetDSObjects();
}
function astroDrawAllObjects(doneObjects)
{ jg.setFont("Lucida Console", fontSize1a+"px", Font.PLAIN);
  for(var i=0;(i<astroObjects.length);i++)
  { if(getAstroObjectValue(i,"type")=='AASTAR1')
    { name=getAstroObjectValue(i,"nameBayer")+'&nbsp;'+getAstroObjectValue(i,"nameBayer2")+'&nbsp;'; 
      if(name!="&nbsp;&nbsp;") name+=getAstroObjectValue(i,"nameCon");
      astroDrawStarObject(getAstroObjectValue(i,"RA2000"),getAstroObjectValue(i,"DE2000"),getAstroObjectValue(i,"vMag"),name,i);
    }
    else if(getAstroObjectValue(i,"type")=='AA1STAR')
      astroDrawStarObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"mag"),getAstroObjectValue(i,"name"),i);
    else if(getAstroObjectValue(i,"type")=='AA2STAR')
      astroDrawStarxObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"mag"),getAstroObjectValue(i,"name"),i);
    else if(getAstroObjectValue(i,"type")=='AA3STAR')
      astroDrawStarxObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"mag"),getAstroObjectValue(i,"name"),i);
    else if(getAstroObjectValue(i,"type")=='AA4STAR')
      astroDrawStarxObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"mag"),getAstroObjectValue(i,"name"),i);
    else if(getAstroObjectValue(i,"type")=='AA5STAR')
      astroDrawStarxObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"mag"),getAstroObjectValue(i,"name"),i);
    else if(getAstroObjectValue(i,"type")=='AA6STAR')
      astroDrawStarxObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"mag"),getAstroObjectValue(i,"name"),i);
    else if(getAstroObjectValue(i,"type")=='AA7STAR')
      astroDrawStarxObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"mag"),getAstroObjectValue(i,"name"),i);
    else if(getAstroObjectValue(i,"type")=='AA8STAR')
      astroDrawStarxObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"mag"),getAstroObjectValue(i,"name"),i);
    else if(getAstroObjectValue(i,"type")=='ASTER')
      astroDrawOCObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='BRTNB')
      astroDrawBRTNBObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='CLANB')
      astroDrawCLANBObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='DRKNB')
      astroDrawDRKNBObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i,10);
    else if(getAstroObjectValue(i,"type")=='DS')
      astroDrawStarxObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"mag"),getAstroObjectValue(i,"name"),i);
    else if(getAstroObjectValue(i,"type")=='EMINB')
      astroDrawBRTNBObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='ENRNN')
      astroDrawBRTNBObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='ENSTR')
      astroDrawBRTNBObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='GALCL')
      astroDrawGXCLObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='GALXY')
      astroDrawGXObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='GLOCL')
      astroDrawGCObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='GXADN')
      astroDrawBRTNBObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='GXAGC')
      astroDrawGCObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='GACAN')
      astroDrawCLANBObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='HII')
      astroDrawHIIObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='LMCCN')
      astroDrawCLANBObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='LMCDN')
      astroDrawBRTNBObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='LMCGC')
      astroDrawGCObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='LMCOC')
      astroDrawOCObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='OPNCL')
      astroDrawOCObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='PLNNB')
      astroDrawPNObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='REFNB')
      astroDrawBRTNBObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='RNHII')
      astroDrawBRTNBObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='SMCCN')
      astroDrawCLANBObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='SMCDN')
      astroDrawBRTNBObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='SMCGC')
      astroDrawGCObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='SMCOC')
      astroDrawOCObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='SNREM')
      astroDrawBRTNBObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='STNEB')
      astroDrawBRTNBObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='QUASR')
      astroDrawQSRObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else if(getAstroObjectValue(i,"type")=='WRNEB')
      astroDrawBRTNBObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    else
      astroDrawBRTNBObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),i);
    }
  ...
  /*if(doneObjects=="DS")
  { canvasreDrawNamedLabel(coordBkGroundColor,coordColor,"Fetching star 6 objects...",5,canvasDimensionYpx-5,500,16,'left','infoline');
    astroGetStars6();
  }
  else if(doneObjects=="S6")
  { canvasreDrawNamedLabel(coordBkGroundColor,coordColor,"Fetching star objects...",5,canvasDimensionYpx-5,500,16,'left','infoline');
    astroGetStars();
  }
  else
  */
  canvasreDrawNamedLabel(coordBkGroundColor,coordColor,atlasPageDone,5,canvasDimensionYpx-5,500,16,'left','infoline');
  jg.paint();
}
...
{ var xmlhttp;
  ...
  url+="&vMag="+starsmagnitude;
  //alert(url);
  xmlhttp.open("GET",url,true);
  xmlhttp.send(null);
}
function astroGetStars6()
{ var xmlhttp;
  if(window.XMLHttpRequest)
    xmlhttp=new XMLHttpRequest();
  else if(window.activeXObject)
  ...
  { if(xmlhttp.readyState==4)
    { var xmlDoc=xmlhttp.responseXML.documentElement;
      astroObjects=xmlDoc.getElementsByTagName("object");
      astroDrawAllObjects("S6");
    }
  };
  var lLhr=Math.max(gridluLhr,gridldLhr);
  var rLhr=Math.min(gridrdLhr,gridruLhr);
  var url="ajaxinterface.php";
  url+="?instruction=getStars6";
  url+="&lLhr="+lLhr;
  url+="&dDdeg="+griddDdeg;
  url+="&rLhr="+rLhr;
  url+="&uDdeg="+griduDdeg;
...
{ var xmlhttp;
  ...
  { if(xmlhttp.readyState==4)
    { var xmlDoc=xmlhttp.responseXML.documentElement;
      astroObjects=xmlDoc.getElementsByTagName("object");
      astroDrawAllObjects("SA");
    }
  };
  var lLhr=Math.max(gridluLhr,gridldLhr);
  var rLhr=Math.min(gridrdLhr,gridruLhr);
  var url="ajaxinterface.php";
  url+="?instruction=getStars";
  url+="&lLhr="+lLhr;
  url+="&dDdeg="+griddDdeg;
  url+="&rLhr="+rLhr;
  url+="&uDdeg="+griduDdeg;
...
{ var ret='';
  if(this.substr(getAstroObjectValue(object,"type"),0,6)=='AASTAR')
  { name=getAstroObjectValue(object,"nameBayer")+'&nbsp;'+getAstroObjectValue(object,"nameBayer2")+'&nbsp;'; 
    if(name!="&nbsp;&nbsp;") name+=getAstroObjectValue(object,"nameCon"); else name=getAstroObjectValue(object,"name");
    ret ="<span style='text-decoration:underline;'>Object:</span> "+name+"<br /> ";
    ret+="Magn: "+(getAstroObjectValue(object,"vMag")/100)+"<br /> ";
    ret+="Type: "+getAstroObjectValue(object,"spType")+"<br /> ";
  }
  else
  { ret ="<span style='text-decoration:underline;'>"+this.atlasPageObjectTxt+":</span> "+getAstroObjectValue(object,"name")+"<br /> ";
    ret+=this.atlasPageConsTxt+": "+getAstroObjectValue(object,"con")+"<br /> ";
    ret+=this.atlasPageTypeTxt+": "+getAstroObjectValue(object,"type")+"<br /> ";
    ret+=this.atlasPageSeenTxt+": "+getAstroObjectValue(object,"seen")+"<br /> ";
    ret+=(((mag =getAstroObjectValue(object,"mag" ))==99.9)?"":this.atlasPageMagnTxt)+(((subr=getAstroObjectValue(object,"subr"))==99.9)?"":"/"+this.atlasPageSubrTxt)+((mag==99.9)?"":": ")+((mag==99.9)?"":mag)+((subr==99.9)?"":"/"+subr)+((mag==99.9)?"":"<br /> ");
    ret+=(( (diam1=(Math.round(getAstroObjectValue(object,"diam1")/6)/10))==0)?"":this.atlasPageDiamTxt+": "+diam1+
         ((((diam2=(Math.round(getAstroObjectValue(object,"diam2")/6)/10))==0)||(diam2==diam1))?"":"x"+diam2)+"'"+(((pa=getAstroObjectValue(object,"pa"))==999)?"":"/"+pa+"&deg;")+"<br /> ");
    ret+=(((descr=getAstroObjectValue(object,"description"))=="")?"":"<hr />"+this.htmlentities(descr)+"<br /> ");
  }
  return ret;
}
...
{ var Legend1a=550;
  canvasDrawStarLegend(canvasOffsetXpx+Legend1a+0, canvasOffsetYpx-5, 1);
  canvasDrawStringRect((((gridDimensions[gridActualDimension][3]))-.5), Legend1a+10, canvasOffsetYpx+canvasDimensionYpx-17, 30, 10, 'center');
  canvasDrawStarLegend(canvasOffsetXpx+Legend1a+50, canvasOffsetYpx-5, 2);
  canvasDrawStringRect((((gridDimensions[gridActualDimension][3]))-1), Legend1a+60, canvasOffsetYpx+canvasDimensionYpx-17, 30, 10, 'center');
  canvasDrawStarLegend(canvasOffsetXpx+Legend1a+100, canvasOffsetYpx-5, 3);
  canvasDrawStringRect((((gridDimensions[gridActualDimension][3]))-1.5), Legend1a+110, canvasOffsetYpx+canvasDimensionYpx-17, 30, 10, 'center');
  canvasDrawStarLegend(canvasOffsetXpx+Legend1a+150, canvasOffsetYpx-5, 4);
  canvasDrawStringRect((((gridDimensions[gridActualDimension][3]))-2), Legend1a+160, canvasOffsetYpx+canvasDimensionYpx-17, 30, 10, 'center');
  canvasDrawStarLegend(canvasOffsetXpx+Legend1a+200, canvasOffsetYpx-5, 5);
  canvasDrawStringRect((((gridDimensions[gridActualDimension][3]))-2.5), Legend1a+210, canvasOffsetYpx+canvasDimensionYpx-17, 30, 10, 'center');
  canvasDrawStarLegend(canvasOffsetXpx+Legend1a+250, canvasOffsetYpx-5, 6);
  ...
  canvasDrawStarLegend(canvasOffsetXpx+Legend1a+300, canvasOffsetYpx-5, 7);
  canvasDrawStringRect((((gridDimensions[gridActualDimension][3]))-3.5), Legend1a+310, canvasOffsetYpx+canvasDimensionYpx-17, 30, 10, 'center');
  canvasDrawStarLegend(canvasOffsetXpx+Legend1a+350, canvasOffsetYpx-5, 8);
  canvasDrawStringRect((((gridDimensions[gridActualDimension][3]))-4), Legend1a+360, canvasOffsetYpx+canvasDimensionYpx-17, 30, 10, 'center');
  canvasDrawStarLegend(canvasOffsetXpx+Legend1a+400, canvasOffsetYpx-5, 9);
  canvasDrawStringRect((((gridDimensions[gridActualDimension][3]))-4.5), Legend1a+410, canvasOffsetYpx+canvasDimensionYpx-17, 30, 10, 'center');
  canvasDrawStarLegend(canvasOffsetXpx+Legend1a+450,canvasOffsetYpx-5,10);
  canvasDrawStringRect((((gridDimensions[gridActualDimension][3]))-5), Legend1a+460, canvasOffsetYpx+canvasDimensionYpx-17, 30, 10, 'center');
  canvasDrawStarLegend(canvasOffsetXpx+Legend1a+500,canvasOffsetYpx-5,11);
  canvasDrawStringRect((((gridDimensions[gridActualDimension][3]))-5.5), Legend1a+510, canvasOffsetYpx+canvasDimensionYpx-17, 30, 10, 'center');
  canvasDrawStarLegend(canvasOffsetXpx+Legend1a+550,canvasOffsetYpx-5,12);
  jg.drawEllipseTilt(Legend1a+0, canvasOffsetYpx+canvasDimensionYpx+5, 10, 5, 45);
  canvasDrawStringRect('GALXY', Legend1a+10, -fontSize1a, 30, 10, 'left');
  jg.drawEllipseTilt(Legend1a+50,canvasOffsetYpx+canvasDimensionYpx+5,5,5,0);
  canvasDrawLine(Legend1a+50-((5+1)>>1),-5, Legend1a+50-5, -5);
  canvasDrawLine(Legend1a+50, -10, Legend1a+50, -5-((5+1)>>1));
  canvasDrawLine(Legend1a+50, 0, Legend1a+50, -5+((5+1)>>1));
  canvasDrawLine(Legend1a+50+((5+1)>>1), -5, Legend1a+50+5, -5);
  canvasDrawStringRect('PLANB', Legend1a+60, -fontSize1a, 30, 10, 'left');
  jg.drawEllipseTilt(Legend1a+100,canvasOffsetYpx+canvasDimensionYpx+5,5,5,0);
  canvasDrawLine(Legend1a+97,-5,Legend1a+103,-5);
  canvasDrawLine(Legend1a+100,-2,Legend1a+100,-8);
  canvasDrawStringRect('GLOCL', Legend1a+110, -fontSize1a, 30, 10, 'left');
  jg.drawEllipseTiltInterval(Legend1a+150, canvasOffsetYpx+canvasDimensionYpx+5, 12, 12, 0, 2);
  canvasDrawStringRect('OPNCL', Legend1a+160, -fontSize1a, 30, 10, 'left');
  canvasDrawLine(Legend1a+194,1,Legend1a+196,1);
  canvasDrawLine(Legend1a+199,1,Legend1a+201,1);
  canvasDrawLine(Legend1a+204,1,Legend1a+206,1);
  canvasDrawLine(Legend1a+194,-11,Legend1a+196,-11);
  canvasDrawLine(Legend1a+199,-11,Legend1a+201,-11);
  canvasDrawLine(Legend1a+204,-11,Legend1a+206,-11);
  canvasDrawLine(Legend1a+194,-11,Legend1a+194,-9);
  canvasDrawLine(Legend1a+194,-6,Legend1a+194,-4);
  canvasDrawLine(Legend1a+194,-1,Legend1a+194,1);
  canvasDrawLine(Legend1a+206,-11,Legend1a+206,-9);
  canvasDrawLine(Legend1a+206,-6,Legend1a+206,-4);
  canvasDrawLine(Legend1a+206,-1,Legend1a+206,1);
  canvasDrawStringRect('DKNEB', Legend1a+210, -fontSize1a, 50, 10, 'left');
  canvasDrawLine(Legend1a+264,1,Legend1a+276,1);
  canvasDrawLine(Legend1a+264,-11,Legend1a+276,-11);
  canvasDrawLine(Legend1a+264,-11,Legend1a+264,1);
  canvasDrawLine(Legend1a+276,-11,Legend1a+276,1);
  canvasDrawStringRect('NEB', Legend1a+280, -fontSize1a, 30, 10, 'left');
  
  canvasDrawLine(Legend1a+314,1,Legend1a+315,1);
  canvasDrawLine(Legend1a+318,1,Legend1a+320,1);
  canvasDrawLine(Legend1a+323,1,Legend1a+324,1);
  canvasDrawLine(Legend1a+316,-1,Legend1a+324,-1);
  
  canvasDrawLine(Legend1a+322,-11,Legend1a+323,-11);
  canvasDrawLine(Legend1a+318,-11,Legend1a+319,-11);
  canvasDrawLine(Legend1a+314,-11,Legend1a+315,-11);
  canvasDrawLine(Legend1a+316,-9,Legend1a+324,-9);
  
  canvasDrawLine(Legend1a+314,-11,Legend1a+314,-11);
  canvasDrawLine(Legend1a+314,-8,Legend1a+314,-7);
  canvasDrawLine(Legend1a+314,-4,Legend1a+314,-3);
  canvasDrawLine(Legend1a+314,0,Legend1a+314,1);

  
  canvasDrawLine(Legend1a+316,-9,Legend1a+316,-1);

  canvasDrawLine(Legend1a+326,1,Legend1a+326,1);
  canvasDrawLine(Legend1a+326,-2,Legend1a+326,-3);
  canvasDrawLine(Legend1a+326,-6,Legend1a+326,-7);
  canvasDrawLine(Legend1a+326,-10,Legend1a+326,-11);
  canvasDrawLine(Legend1a+324,-9,Legend1a+324,-1);
  canvasDrawStringRect('CLANB', Legend1a+330, -fontSize1a, 30, 10, 'left');
...
{ x=event.clientX;
  ...
  { if (document.getElementById("atlasPageDiv").style.cursor!='crosshair')
    ...
    if(document.getElementById('cursorpos'))
      canvasreDrawNamedLabel(coordBkGroundColor,coordColor,coordGridLxDyToString(),0,-canvasOffsetYpx,150,fontSize1a+4,'center','cursorpos');
    else
      canvasDrawNamedLabel(coordBkGroundColor,coordColor,coordGridLxDyToString(),0,-canvasOffsetYpx,150,fontSize1a+4,'center','cursorpos');
  }
...
{ if(substr(getAstroObjectValue(object,"type"),0,6)!='AASTAR')
    location='index.php?indexAction=quickpick&source=quickpick&myLanguages=true&object='+urlencode(getAstroObjectValue(object,"name"))+'&searchObjectQuickPickQuickPick=Search%A0Object';
}
...
{ jg.setFont("Lucida Console", fontSize1a+"px", Font.PLAIN);
  ...
  { Lhr=gridL0rad*f12OverPi+12+.01;
    RhrNeg=gridL0rad*f12OverPi-12;
    Udeg=90;
...
{ jg.setFont("Lucida Console", fontSize1a+"px", Font.PLAIN);
  t1 =atlasPageFoV+' '+(Math.round(gridSpanL*20)/10)+" x "+(Math.round(gridSpanD*20)/10)+"° - ";
  t1+=atlasPageDSLM+' '+atlasmagnitude+" - ";
  t1+=atlasPageStarLM+' '+starsmagnitude;
  canvasDrawNamedLabel(coordBkGroundColor,coordColor,t1,150,-canvasOffsetYpx,((t1.length)*fontSize1b)+20,fontSize1a+4,'left','gridInfo');
}
