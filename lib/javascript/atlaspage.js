...
function astroDrawHII(Lhr,Ddeg,diam1,diam2,pa, nm, seen)
{ if(diam2==0) diam2=diam1;
  gridDrawRectangleCWH(Lhr,Ddeg,diam1,diam1,pa,nm,seen);
}
...
{ for(var i=0;(i<astroObjects.length);i++)
  { //if(i==73) alert('i: '+i+' tot: '+getAstroObjectValue(i,"type"));
    ...
    if(getAstroObjectValue(i,"type")=='AASTAR1')
      ...
      astroDrawStar(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"mag"));
...
//      astroDrawDRKNB (getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"));
    astroDrawDRKNBObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"),(getAstroObjectValue(i,"name")));
      ...
      astroDrawHII(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"diam1"),getAstroObjectValue(i,"diam2"),getAstroObjectValue(i,"pa"),(getAstroObjectValue(i,"name")),getAstroObjectValue(i,"seen"));
