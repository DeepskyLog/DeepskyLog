...
const f12OverPi = 3.8197186342054880584532103209403;
const f180OverPi = 57.295779513082320876798154814105;
const fPiOver2 = 1.5707963267948966192313216916398;
const fPiOver12 = 0.26179938779914943653855361527329;
const fPiOver180 = 0.017453292519943295769236907684886;
const f2Pi = 6.283185307179586476925286766559;
...
{ canvasDrawStarLegend(canvasOffsetXpx+550, canvasOffsetYpx-5, 1);
  canvasDrawStringRect((((gridDimensions[gridActualDimension][3]))-.5), 560, canvasOffsetYpx+canvasDimensionYpx-17, 30, 10, 'center');
  canvasDrawStarLegend(canvasOffsetXpx+600, canvasOffsetYpx-5, 2);
  canvasDrawStringRect((((gridDimensions[gridActualDimension][3]))-1), 610, canvasOffsetYpx+canvasDimensionYpx-17, 30, 10, 'center');
  canvasDrawStarLegend(canvasOffsetXpx+650, canvasOffsetYpx-5, 3);
  canvasDrawStringRect((((gridDimensions[gridActualDimension][3]))-1.5), 660, canvasOffsetYpx+canvasDimensionYpx-17, 30, 10, 'center');
  canvasDrawStarLegend(canvasOffsetXpx+700, canvasOffsetYpx-5, 4);
  canvasDrawStringRect((((gridDimensions[gridActualDimension][3]))-2), 710, canvasOffsetYpx+canvasDimensionYpx-17, 30, 10, 'center');
  canvasDrawStarLegend(canvasOffsetXpx+750, canvasOffsetYpx-5, 5);
  canvasDrawStringRect((((gridDimensions[gridActualDimension][3]))-2.5), 760, canvasOffsetYpx+canvasDimensionYpx-17, 30, 10, 'center');
  canvasDrawStarLegend(canvasOffsetXpx+800, canvasOffsetYpx-5, 6);
  canvasDrawStringRect((((gridDimensions[gridActualDimension][3]))-3), 810, canvasOffsetYpx+canvasDimensionYpx-17, 30, 10, 'center');
  canvasDrawStarLegend(canvasOffsetXpx+850, canvasOffsetYpx-5, 7);
  canvasDrawStringRect((((gridDimensions[gridActualDimension][3]))-3.5), 860, canvasOffsetYpx+canvasDimensionYpx-17, 30, 10, 'center');
  canvasDrawStarLegend(canvasOffsetXpx+900, canvasOffsetYpx-5, 8);
  canvasDrawStringRect((((gridDimensions[gridActualDimension][3]))-4), 910, canvasOffsetYpx+canvasDimensionYpx-17, 30, 10, 'center');
  canvasDrawStarLegend(canvasOffsetXpx+950, canvasOffsetYpx-5, 9);
  canvasDrawStringRect((((gridDimensions[gridActualDimension][3]))-4.5), 960, canvasOffsetYpx+canvasDimensionYpx-17, 30, 10, 'center');
  canvasDrawStarLegend(canvasOffsetXpx+1000,canvasOffsetYpx-5,10);
  canvasDrawStringRect((((gridDimensions[gridActualDimension][3]))-5), 1010, canvasOffsetYpx+canvasDimensionYpx-17, 30, 10, 'center');
  canvasDrawStarLegend(canvasOffsetXpx+1050,canvasOffsetYpx-5,11);
  canvasDrawStringRect((((gridDimensions[gridActualDimension][3]))-5.5), 1060, canvasOffsetYpx+canvasDimensionYpx-17, 30, 10, 'center');
  canvasDrawStarLegend(canvasOffsetXpx+1100,canvasOffsetYpx-5,12);
}
