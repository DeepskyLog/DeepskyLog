...
{ for(var i=0;(i<astroObjects.length);i++)
  { //if(i==73) alert('i: '+i+' tot: '+getAstroObjectValue(i,"type"));
    ...
    if(getAstroObjectValue(i,"type")=='AASTAR1')
      ...
      astroDrawStarObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"mag"),i);
    else if(getAstroObjectValue(i,"type")=='AA2STAR')
      astroDrawDStarObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"mag"),i);
...
{ myDiv1x=event.clientX;
  ...
  document.getElementById("myDiv1").innerHTML="<span style='text-decoration:underline;'>Object:</span> ";
  document.getElementById("myDiv1").innerHTML+=getAstroObjectValue(object,"name")+"<br /> "+
                                               "Last seen: "+getAstroObjectValue(object,"seen")+"<br /> "+
                                               getAstroObjectValue(object,"seen")+"<br /> ";
}
