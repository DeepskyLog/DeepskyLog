...
function astroDrawDStarObject(Lhr,Ddeg,mag,object)
{ var d=Math.round((gridActualDimension-mag-1)*1.5);
  var e=Math.max(Math.round(d*1.2),d+2);
  if(d<=0) return false;
  jg.setColor(starColor);
...
{ jg.setFont("verdana,geneva,helvetica,sans-serif", "10px", Font.PLAIN);
  ...
  { if(getAstroObjectValue(i,"type")=='AASTAR1')
    { name=getAstroObjectValue(i,"nameBayer")+'&nbsp;'+getAstroObjectValue(i,"nameBayer2")+'&nbsp;'; 
      ...
      astroDrawDStarObject(getAstroObjectValue(i,"ra"),getAstroObjectValue(i,"decl"),getAstroObjectValue(i,"mag"),getAstroObjectValue(i,"name"),i);
...
{ var ret='';
  ...
  { ret ="<span style='text-decoration:underline;'>Object:</span> "+getAstroObjectValue(object,"name")+"<br /> ";
    ...
    ret+="Magn: "+getAstroObjectValue(object,"mag")+"<br /> ";
    ret+="Subr: "+getAstroObjectValue(object,"subr")+"<br /> ";
  }
  return ret;
}
...
{ myDiv1x=event.clientX;
  ...
  document.getElementById("myDiv1").style.width="200px";
