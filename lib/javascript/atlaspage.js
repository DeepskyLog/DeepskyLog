...
{ var ret='';
  ...
  { ret ="<span style='text-decoration:underline;'>Object:</span> "+getAstroObjectValue(object,"name")+"<br /> ";
    ...
    ret+="Cons: "+getAstroObjectValue(object,"con")+"<br /> ";
    ret+="Seen: "+getAstroObjectValue(object,"seen")+"<br /> ";
    ret+=(((mag =getAstroObjectValue(object,"mag" ))==99.9)?"":"Magn")+(((subr=getAstroObjectValue(object,"subr"))==99.9)?"":"/Subr")+((mag==99.9)?"":": ")+((mag==99.9)?"":mag)+((subr==99.9)?"":"/"+subr)+((mag==99.9)?"":"<br /> ");
