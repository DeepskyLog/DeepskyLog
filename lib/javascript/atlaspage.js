...
{ divInit('atlasPageDiv');
  ...
  this.onKeyDown=this.canvasOnClick;
}
...
{ if(event.keyCode==76)
  ...
  if(event.keyCode==72)
	{ helpOn=!(helpOn);
	  if(!(helpOn))
	  { document.getElementById("atlasPageDiv2").style.left='0px';
	    document.getElementById("atlasPageDiv2").style.top='0px';
	    document.getElementById("atlasPageDiv2").style.width='0px';
	    document.getElementById("atlasPageDiv2").style.height='0px';
	  }
	  else
...
{ x=event.clientX;
  ...
  {	document.getElementById("atlasPageDiv1").style.left='0px';
    document.getElementById("atlasPageDiv1").style.top='0px';
    document.getElementById("atlasPageDiv1").style.width='0px';
    document.getElementById("atlasPageDiv1").style.height='0px';
