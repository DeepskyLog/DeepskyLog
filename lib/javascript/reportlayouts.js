...
{ echostring='<hr />';
  ...
  echostring+="<td class=\"centered\">"+"On line-y"+"</td>";
  echostring+="<td class=\"centered\">"+"Position-x"+"</td>";
  echostring+="<td class=\"centered\">"+"Width"+"</td>";
  echostring+="<td class=\"centered\">"+"Style"+"</td>";
  echostring+="<td>"+"Text before:"+"</td>";
  echostring+="<td>"+"Text after:"+"</td>";
  echostring+="</tr>";  
  for(i=0,j=0;i<this.ajaxanswer.length;i++)
  { if(this.ajaxanswer[i]["fieldstyle"]!="LAYOUTMETADATA")
    { greyed=((this.ajaxanswer[i]["fieldwidth"]=="0")?"greyed":"");
      echostring+="<tr class=\"type"+(j%2)+"\">";  
      echostring+="<td class=\"right width125px\">"+this.titles[this.ajaxanswer[i]["fieldname"]]+"</td>";
