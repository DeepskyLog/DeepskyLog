...
{ echostring='<hr />';
  ...
  echostring+="<td>"+titles['ReportFieldLegend']+"</td>";
  echostring+="</tr>";  
  ...
  { if(this.ajaxanswer[i]["fieldstyle"]!="LAYOUTMETADATA")
    { greyed=((this.ajaxanswer[i]["fieldwidth"]=="0")?"greyed":"");
      ...
      echostring+="<td                   >"+"<input id=\"fieldlegend"  +j+"\"class=\"tableinputtext          blike"+greyed+"\" type=\"text\" value=\""+this.ajaxanswer[i]["fieldlegend"]   +"\"  onchange=\"newnamevaluetext('"+this.ajaxanswer[i]["fieldname"] +"','fieldlegend','fieldlegend"     +j+"');\"/>"+"</td>";
      echostring+="</tr>";
      j++;
    }
  }
