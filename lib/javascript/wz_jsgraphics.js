...
var canvasOffsetXpx=0,   canvasOffsetYpx=0;                                     // Canvas Offset X and Offset Y: distance of the canvas relative to the client window;
var canvasDimensionXpx,  canvasDimensionYpx;                                    // Canvas Dimension X and Dimension Y: width and height of the canvas;
var divOffsetXpx,        divOffsetXpx;                                          // div offsets
...
var gridOffsetXpx=100,   gridOffsetYpx=50;                                      // Grid offset X and offset Y: distance obetween the grid and the canvas border;
...
{ document.getElementById(theDiv).style.left=divOffsetXpx+'px';
  ...
  document.getElementById(theDiv).style.width=(document.getElementById('div5').style.width-divOffsetXpx-divOffsetX2px)+'px';
  document.getElementById(theDiv).style.height=(document.getElementById('div5').style.height-divOffsetYpx-divOffsetY2px)+'px';
}
...
{ alert('WP0');
  ...
  divOffsetY2px=0;
  initDiv('myDiv');
  canvasOffsetXpx=20;canvasOffsetYpx=20;
  canvasDimensionXpx=((document.body.getElementById('div5').style.width-divOffsetXpx-divOffsetX2px)-(2*canvasOffsetXpx));
  canvasDimensionYpx=((document.body.getElementById('div5').style.height-divOffsetYpx-divOffsetY2px)-(2*canvasOffsetYpx));
  jgCanvasInit('myDiv');
  gridOffsetXpx=100;gridOffsetYpx=50;
  jgGridInit();
  jgGridInitScale(0,0,10);
  jgGridSetHotZones();
  ...
  element.setAttribute('onclick','location=\"http://www.bipt.be\"');
