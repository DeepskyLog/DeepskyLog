...
function _mkOvTiltLimited(cx, cy, wx, hy, angle, lx, rx, ty, by, nm)
{	var a=(++wx)>>1,
	    b=(++hy)>>1;
  if(a<1) a=1;
  if(b<1) b=1;
  ...
  x=xr,y=yr,h=0,w=0,d=-1;
	...
	if(((cx+xr+2)>lx)&&((cx+xr+50)<rx)&&((cy+yr)<ty)&&((cy+yr)>by))
...
function jsGraphics(cnv, wnd)
{
	...
	this.drawEllipseTiltLimited = this.drawOvalTiltLimited = function(x, y, w, h, a, lx, rx, ty, by, nm)
	{ 
		this._mkOvTiltLimited(x, y, w, h, a, lx, rx, ty, by, nm);
	};
