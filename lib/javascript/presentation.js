...
var theLeftMenu = 'show';
var theTopMenu = 'show';
var theLeftMenuContents='';
var theTopMenuContents='';
...
function resizeForm(leftmenu,topmenu)
{ if(theLeftMenuContents=='')
    theLeftMenuContents=document.getElementById('div3').innerHTML;
  if(theTopMenuContents=='')
    theTopMenuContents=document.getElementById('div1').innerHTML;
  ...
  if((leftmenu=='show') && document.getElementById && document.getElementById('div4') /*&& (document.getElementById('div4').style.left!='158px')*/)
  { document.getElementById('div3').onmouseover="";
	document.getElementById('div3').innerHTML=theLeftMenuContents;
    document.getElementById('div3').style.width='153px';
    document.getElementById('div4').style.left='158px';
    ...
    document.getElementById('div5').style.left='169px';
    document.getElementById('div5').style.width= (width-185)+'px';
    document.getElementById('div6').style.left= '158px';
    document.getElementById('div6').style.width= (width-169)+'px';
  }
  if((leftmenu=='hidden') && document.getElementById && document.getElementById('div4') /*&& (document.getElementById('div4').style.left!='5px')*/)
  { document.getElementById('div3').innerHTML='';
    document.getElementById('div3').style.width='5px';
    document.getElementById('div4').style.left='5px';
    document.getElementById('div4').style.width =(width-10)+'px';
    document.getElementById('div4c').style.left =(width-21)+'px';
    document.getElementById('div4d').style.left =(width-21)+'px';
    div5Width=(width-22);
    div5StdWidth=(width-22);
    document.getElementById('div5').style.left= '16px';
    document.getElementById('div5').style.width= (width-32)+'px';
    document.getElementById('div6').style.left= '5px';
    document.getElementById('div6').style.width= (width-16)+'px';
  }
  if((topmenu=='show') && document.getElementById && document.getElementById('div4') /*&& (document.getElementById('div4').style.top!='89px')*/)
  { document.getElementById('div1').onmouseover="";
	document.getElementById('div1').innerHTML=theTopMenuContents;
    document.getElementById('div1').style.height='64px';
    document.getElementById('div2').style.top='64px';
    document.getElementById('div3').style.top='95px';
    document.getElementById('div3').style.height=(height-113)+'px';
    document.getElementById('div4').style.top='94px';
    document.getElementById('div4').style.height=(height-115)+'px';
    document.getElementById('div4b').style.top = (height-133)+'px';
    document.getElementById('div4d').style.top = (height-133)+'px';
    document.getElementById('div5').style.top='104px';
    document.getElementById('div5').style.height=(height-133)+'px';
  ...
  if((topmenu=='hidden') && document.getElementById && document.getElementById('div4') /*&& (document.getElementById('div4').style.top!='25px')*/)
  { document.getElementById('div1').innerHTML='';
    document.getElementById('div1').style.height='5px';
    document.getElementById('div2').style.top='5px';
    document.getElementById('div3').style.top='26px';
    document.getElementById('div3').style.height=(height-54)+'px';
    document.getElementById('div4').style.top='30px';
    document.getElementById('div4').style.height=(height-54)+'px';
    document.getElementById('div5').style.top='35px';
    document.getElementById('div4b').style.top = (height-68)+'px';
    document.getElementById('div4d').style.top = (height-68)+'px';
    document.getElementById('div5').style.height=(height-64)+'px';
    div5Height=(height-68);
    div5StdHeight=(height-68);
    document.getElementById('div6').style.top=   (height-28)+'px';
    if(theResizeElement)
    { height-=findVerticalPosition(theResizeElement);
	  height-=theResizeSize;
...
{ var height=theClientHeight;
  var width=theClientWidth;
  if((topmenu=='show') && document.getElementById && document.getElementById('view_catalogs_left') && document.getElementById('view_catalogs_right'))
  { document.getElementById('view_catalogs_left').style.height=(height-133)+'px';
    document.getElementById('view_catalogs_right').style.height=(height-133)+'px';
   }
  else if(document.getElementById && document.getElementById('view_catalogs_left') && document.getElementById('view_catalogs_right'))
  { document.getElementById('view_catalogs_left').style.height=(height-69)+'px';
    document.getElementById('view_catalogs_right').style.height=(height-69)+'px';
  }	  
  if((leftmenu=='show') && document.getElementById && document.getElementById('view_catalogs_left') && document.getElementById('view_catalogs_right'))
  { document.getElementById('view_catalogs_right').style.width =(width-400)+'px';
  }
  else if (document.getElementById && document.getElementById('view_catalogs_left') && document.getElementById('view_catalogs_right'))
  { document.getElementById('view_catalogs_right').style.width =(width-245)+'px';
  }
}
theResizeElement='';
theResizeSize=0;
...
{ var height=div5Height;
  ...
  document.getElementById('veil').style.filter='alpha(opacity=20)';
  document.getElementById('veil').style.opacity=0.2;
  document.getElementById('dialogback').style.top=((height-dy)/2)+'px';
  document.getElementById('dialogback').style.left =((width-dx)/2)+'px';
  document.getElementById('dialogback').style.height=dy+'px';
  document.getElementById('dialogback').style.width =dx+'px';
  document.getElementById('dialogback').style.filter='alpha(opacity=30)';
  document.getElementById('dialogback').style.opacity=0.3;
  document.getElementById('dialog').style.top=(((height-dy)/2)-5)+'px';
  document.getElementById('dialog').style.left =(((width-dx)/2)-5)+'px';
...
{ i=0;
  ...
  { titleData[i]=document.getElementById('C'+i).innerHTML;
    ...
    var tempAttributes= new Array(); var tempAttributesValues = new Array();
    tempAttributes[tempAttributes.length]=theClassName;
    tempAttributesValues[tempAttributesValues.length]=document.getElementById('C'+i).getAttribute(theClassName);
    
    titleAttributes[i]=tempAttributes;
    titleAttributesValues[i]=tempAttributesValues;
    
    j=0; var tempColumnData= new Array(); var tempColumnAttributes = new Array(); var tempColumnAttributesValues = new Array();
    ...
    { tempColumnData[j]=document.getElementById('C'+i+'D'+j).innerHTML;
      ...
      var tempAttributes= new Array(); var tempAttributesValues = new Array();
      tempAttributes[tempAttributes.length]=theClassName;
	  tempAttributesValues[tempAttributesValues.length]=document.getElementById('C'+i+'D'+j).getAttribute(theClassName);
	  tempAttributes[tempAttributes.length]='onmouseover';
	  tempAttributesValues[tempAttributesValues.length]=document.getElementById('C'+i+'D'+j).getAttribute('onmouseover');
...
function setColumnsOrder(newcookiestring)
{ //read all orders cookie
  var i;
  ...
  //get the cookies
  var orderColumns=eval(getCookie('orderColumns440'));
  cookiestring='';
  ...
  for(i=0;i<orderColumnSourceOrder.length;i++)
    cookiestring=cookiestring+"['"+theColumnSource+"','"+orderColumnSourceOrder[i]+"'],";  
  //rewrite the cookies
  var exdate= new Date();
  exdate.setDate(exdate.getDate()+365);
  document.cookie="orderColumns440=["+cookiestring.substr(0,cookiestring.length-1)+"];expires="+exdate.toUTCString();	 
}
...
{ var i;
  ...
  //get the cookies
  var restoreColumns=eval(getCookie('restoreColumns440'));
  cookiestring='';
  //rebuild the other cookies
  if(restoreColumns)
  for(i=0;i<restoreColumns.length;i++)
   if(restoreColumns[i][0]!=theColumnSource)
     cookiestring=cookiestring+"['"+restoreColumns[i][0]+"','"+restoreColumns[i][1]+"','"+restoreColumns[i][2]+"'],";
   //add the own cookies
  for(i=0;i<restoreColumnsSourceCollapsed.length;i++)
    cookiestring=cookiestring+"['"+theColumnSource+"','"+restoreColumnsSourceCollapsed[i]+"','"+restoreColumnsSourceCollapsedHeaders[i]+"'],";  
  //rewrite the cookies
  var exdate= new Date();
  exdate.setDate(exdate.getDate()+365);
  document.cookie="restoreColumns440=["+cookiestring.substr(0,cookiestring.length-1)+"];expires="+exdate.toUTCString();	 
}
//read the column order for this columnSource (=form) into an array => orderColumnsSourceOrder
function readOrderColumnSourceOrder()
{ var i;
  //read all orders cookie
  var orderColumns=eval(getCookie('orderColumns440'));
  //filter this form's orders => orderColumnSourceOrder
...
//read the collapsed columns for this columnSource (=form) into an array => restoreColumnsSourceCollapsed
function readCollapseColumnsSourceCollapsed()
{ var i;
  var cookie = new Array();
  //read all restore columns cookie
  if(getCookie('restoreColumns440'))
    cookie=eval(getCookie('restoreColumns440'));
  restoreColumnsSourceCollapsed=new Array();
  restoreColumnsSourceCollapsedHeaders=new Array();
  for(i=0;i<cookie.length;i++)
  { //handle cookies for this form
...
{ i=0;
  ...
  { document.getElementById('C'+i).innerHTML=titleData[orderColumnSourceOrder[i].substr(1)];
    ...
    { if(titleAttributesValues[orderColumnSourceOrder[i].substr(1)][t])
    	document.getElementById('C'+i).setAttribute(titleAttributes[orderColumnSourceOrder[i].substr(1)][t], titleAttributesValues[orderColumnSourceOrder[i].substr(1)][t]);
      t++;
    }
    j=0;
    ...
    { document.getElementById('C'+i+'D'+j).innerHTML=columnData[orderColumnSourceOrder[i].substr(1)][j];
      ...
      { document.getElementById('C'+i+'D'+j).setAttribute(columnAttributes[orderColumnSourceOrder[i].substr(1)][j][t], columnAttributesValues[orderColumnSourceOrder[i].substr(1)][j][t]);
        t++;
      }
      j++;
    }
...
{ var i;
  for(i=0;i<restoreColumnsSourceCollapsed.length;i++)
  { //check actual location if column
	k=0;
	while((k<orderColumnSourceOrder.length) && (orderColumnSourceOrder[k]!=restoreColumnsSourceCollapsed[i]))
	  k++;
	if(k<orderColumnSourceOrder.length)
	{ //empty column title
	  document.getElementById('C'+k).innerHTML="<a href=\"#\" class=\"centered width100pct\" onclick=\"restoreColumn('"+restoreColumnsSourceCollapsed[i]+"');return false;\" title=\""+restoreColumnsSourceCollapsedHeaders[i]+"\">.</a>";
	  j=0; 
...
function removeColumn(theColumn, header0)
{ var i;
  //check actual location if column
  k=0;
  while((k<orderColumnSourceOrder.length) && (orderColumnSourceOrder[k]!=theColumn))
    k++;
  if(orderColumnSourceOrder[k]!=theColumn)
    return;
  //empty column
  document.getElementById('C'+k).innerHTML="<a href=\"#\" class=\"centered width100pct\" onclick=\"restoreColumn('"+theColumn+"');return false;\" title=\""+header0+"\">.</a>";
  i=0; 
  ...
  cookiestring=cookiestring+"['"+theColumnSource+"','"+theColumn+"','"+header0+"']";
  var exdate= new Date();
  exdate.setDate(exdate.getDate()+365);
  document.cookie="restoreColumns440=["+cookiestring+"];expires="+exdate.toUTCString();
}
function moveColumnLeft(theColumn)
{ //move column left in order array
  var i;
...
function moveColumnRight(theColumn)
{ //move column right in order array
  var i;
...
{ k=0;
  ...
  { document.getElementById('C'+k+'D'+j).innerHTML=columnData[theColumn.substr(1)][j];
    j++;
  }
  ...
  var exdate= new Date();
  exdate.setDate(exdate.getDate()+365);
  document.cookie="restoreColumns440=["+cookiestring.substring(0, (cookiestring.length-1))+"];expires="+exdate.toUTCString();
  return false;
}
function getColumnsOrder()
{ if(getCookie('orderColumns440'))
	orderColumns=eval(getCookie('orderColumns440'));
  var cookiestring='';
