...
{ for(i=0;i<restoreColumnsSourceCollapsed.length;i++)
  { //check actual location if column
	...
	while(orderColumnSourceOrder[k]!=restoreColumnsSourceCollapsed[i])
	  k++;
	//empty column title
	document.getElementById('C'+k).innerHTML="<a href=\"#\" class=\"centered width=100pct\" onclick=\"restoreColumn('"+restoreColumnsSourceCollapsed[i]+"');return false;\" title=\""+restoreColumnsSourceCollapsedHeaders[i]+"\">.</a>";
	j=0; 
