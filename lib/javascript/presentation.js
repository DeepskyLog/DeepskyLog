...
{ var height=window.innerHeight;
  ...
  { document.getElementById('div1').style.visibility='hidden';
    ...
    document.getElementById('div4b').style.top = (height-64)+'px';
    document.getElementById('div4d').style.top = (height-64)+'px';
...
{ //read all orders cookie
  ...
  //get the cookies
  var orderColumns=eval(getCookie('orderColumns390'));
  cookiestring='';
  ...
  document.cookie="orderColumns390=["+cookiestring.substr(0,cookiestring.length-1)+"];expires="+exdate.toUTCString();	 
}
...
{ var cookie = new Array();
  ...
  //get the cookies
  var restoreColumns=eval(getCookie('restoreColumns390'));
  cookiestring='';
  //rebuild the other cookies
  if(restoreColumns)
  ...
  var exdate= new Date();
  exdate.setDate(exdate.getDate()+365);
  document.cookie="restoreColumns390=["+cookiestring.substr(0,cookiestring.length-1)+"];expires="+exdate.toUTCString();	 
}
...
{ var cookie = new Array();
  //read all restore columns cookie
  if(getCookie('restoreColumns390'))
    cookie=eval(getCookie('restoreColumns390'));
  restoreColumnsSourceCollapsed=new Array();
  restoreColumnsSourceCollapsedHeaders=new Array();
  for(i=0;i<cookie.length;i++)
  { //handle cookies for this form
...
{ //check actual location if column
  ...
  var exdate= new Date();
  exdate.setDate(exdate.getDate()+365);
  document.cookie="restoreColumns390=["+cookiestring+"];expires="+exdate.toUTCString();
}
...
{ k=0;
  ...
  var exdate= new Date();
  exdate.setDate(exdate.getDate()+365);
  document.cookie="restoreColumns390=["+cookiestring.substring(0, (cookiestring.length-1))+"];expires="+exdate.toUTCString();
  return false;
}
function getColumnsOrder()
{ var cookie = new Array();
  if(getCookie('orderColumns390'))
	orderColumns=eval(getCookie('orderColumns390'));
  var cookiestring='';
