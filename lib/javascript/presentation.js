...
{ //read all orders cookie
  ...
  document.cookie="orderColumns410=["+cookiestring.substr(0,cookiestring.length-1)+"];expires="+exdate.toUTCString();	 
}
...
{ var cookie = new Array();
  ...
  var exdate= new Date();
  exdate.setDate(exdate.getDate()+365);
  document.cookie="restoreColumns410=["+cookiestring.substr(0,cookiestring.length-1)+"];expires="+exdate.toUTCString();	 
}
...
{ //check actual location if column
  ...
  var exdate= new Date();
  exdate.setDate(exdate.getDate()+365);
  document.cookie="restoreColumns410=["+cookiestring+"];expires="+exdate.toUTCString();
}
...
{ k=0;
  ...
  var exdate= new Date();
  exdate.setDate(exdate.getDate()+365);
  document.cookie="restoreColumns410=["+cookiestring.substring(0, (cookiestring.length-1))+"];expires="+exdate.toUTCString();
  return false;
}
