...
{ i=0;
  ...
  document.cookie="restoreColumns=["+cookiestring.substring(0, (cookiestring.length-1))+"];expires="+exdate.toGMTString();
  return false;
}
...
{ var restoreThisColumn= new Array();
  ...
  var exdate= new Date();
  exdate.setDate(exdate.getDate()+365)
  document.cookie="restoreColumns=["+cookiestring+"];expires="+exdate.toGMTString();
}
