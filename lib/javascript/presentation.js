...
{ //document.getElementById('div2').innerHTML='Resize: top:'+topmenu+'    left:'+leftmenu+'   ';
  ...
  { //document.getElementById('div2').innerHTML=document.getElementById('div2').innerHTML+' showing top ';
  ...
  else if((topmenu=='hide') && document.getElementById && document.getElementById('div4') && (document.getElementById('div4').style.top!='25px'))
  { //document.getElementById('div2').innerHTML=document.getElementById('div2').innerHTML+' hiding top ';
    document.getElementById('div1').style.visibility='hidden';
    document.getElementById('div2').style.top='0px';
    document.getElementById('div3').style.top='21px';
    document.getElementById('div4').style.top='25px';
    document.getElementById('div4').style.height=(height-49)+'px';
    document.getElementById('div5').style.top='30px';
    document.getElementById('div4b').style.top = (height-63)+'px';
    document.getElementById('div4d').style.top = (height-63)+'px';
    document.getElementById('div5').style.height=(height-59)+'px';
    div5Height=(height-63);
    div5StdHeight=(height-63);
    document.getElementById('div6').style.top=   (height-28)+'px';
    if(theResizeElement)
    { height-=findVerticalPosition(theResizeElement);
	  height-=theResizeSize;
  ...
  { //document.getElementById('div2').innerHTML=document.getElementById('div2').innerHTML+' showing left ';
  ...
  if((leftmenu=='hide') && document.getElementById && document.getElementById('div4') && (document.getElementById('div4').style.left!='5px'))
  { document.getElementById('div2').innerHTML=document.getElementById('div2').innerHTML+' hiding left ';
    document.getElementById('div3').innerHTML='';
    document.getElementById('div3').style.height=(height-49)+'px';;
