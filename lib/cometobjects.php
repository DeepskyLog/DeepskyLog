...
class CometObjects
{
    ...
    public function getObjectFromQuery($queries, $sort, $exact = 0)
    {
        global $objDatabase;
    ...
    public function getSelectedObjects($dbfield, $value)
    {
        global $objDatabase;
    ...
    public function getExactObject($value)
    {
        global $objDatabase;
    ...
    public function getSortedObjects($sort)
    {
        global $objDatabase;
    ...
    public function my_array_unique($somearray)
    {
    ...
    public function getObservedbyUser($name, $observerid)
    {
    ...
    // is not yet observed
    public function getObserved($name)
    {
        $observations = new CometObservations();
    ...
    public function setIcqName($id, $icq)
    {
        global $objDatabase;
