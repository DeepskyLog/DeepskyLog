...
//  $pdf->selectFont($fontdir);
 ...
 function csvObjects($result)
 {
  ...
  if ($diam1 != 0.0)
   ...
   echo $valueA[0].";". $alt .";".$this->raToString($valueA[7]).";".$this->decToString($valueA[8], 0).";".$$con.";".$$type.";".$mag.";".$sb.";".$size.";".$pa.";".$page.";".$valueA[17].";".$magnifi.";".$valueA[3]."\n";
   }
 }
 ...
 function argoObjects($result)
 {
  ...
  if ($diam1 != 0.0)
   ...
   echo "DSL " . sprintf("%03d", $counter) . " " . $valueA[0]."|".$this->raToString($valueA[7])."|".$this->decToString($valueA[8], 0)."|".$$argotype."|".$mag."|".$size.";".$atlas." ".$page.";CR ".$valueA[17].";".$valueA[3]."\n";
   $counter++;
   }
 }
