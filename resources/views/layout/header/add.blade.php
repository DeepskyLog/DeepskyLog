<li class="nav-item dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
        {{--        <a class="dropdown-item" href="/observation/create">{{ _i('Observation') }}</a>
        <a class="dropdown-item disabled" href="#">───────────────────</a>
        <a class="dropdown-item" href="/observingList/create">{{ _i('Observing list') }}</a>
        <a class="dropdown-item" href="/session/create">{{ _i("Session") }}</a>
        <a class="dropdown-item disabled" href="#">───────────────────</a>
        --}}
        @if (!auth()->user()->isAdmin())
        <a class="dropdown-item" href="/instrument/create">{{ _i("Instrument") }}</a>
