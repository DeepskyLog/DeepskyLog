<nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav">
            <button class="btn btn-light bi bi-subtract" width="32" height="32" id="darkSwitch"
                style="margin-right:5px;border:0;" alt="Night Mode">
                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-circle-half icon" fill="currentColor"
                    xmlns="http://www.w3.org/2000/svg">
            ...
            @else
            @include('layout.header.user', ['user' => Auth::user()])

            <button class="btn" style="margin-right:5px;border:0;">
                <a href="/messages">
                    <?php $count = Auth::user()->newThreadsCount(); ?>
                    <svg class="inline" width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-envelope-open icon"
