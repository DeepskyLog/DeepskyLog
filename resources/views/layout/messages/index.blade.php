...
<a class="btn btn-primary" role="button" href="/messages/create">
    <svg width="1.3em" height="1.3em" viewBox="0 0 16 16" class="bi bi-envelope-open icon inline" fill="currentColor"
...
<a name="" id="" class="btn btn-primary" href="/messages/markAllRead" role="button">
    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check2-all inline" fill="currentColor"
        xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd"
