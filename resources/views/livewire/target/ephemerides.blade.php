<div>
    @if (!$target->isPlanetMoon() && ($target->ra != null && $target->decl != null))
        ...
        <table class="table table-sm table-striped">
            ...
            <tr>
                ...
                <td class="centered {{ $ephem['max_alt_color'] }}">
                    <span class="" data-toggle="tooltip" data-placement="bottom" title=""
                        data-original-title="{{ $ephem['max_alt_popup']}}">
                        {!! $ephem['max_alt'] !!}
                    </span>
                </td>
            ...
            <tr>
                ...
                <td class="centered {{ $ephem['transit_color'] }}">
                    <span class="" data-toggle="tooltip" data-placement="bottom" title=""
                        data-original-title="{{ $ephem['transit_popup']}}">
                        {{ $ephem['transit'] }}
                    </span>
                </td>
                @endforeach
            ...
            <tr>
                ...
                <td class="centered {{ $ephem['rise_color'] }}">
                    <span class="" data-toggle="tooltip" data-placement="bottom" title=""
                        data-original-title="{{ $ephem['rise_popup']}}">
