                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="username"
                                class="col-md-4 col-form-label text-md-right">{{ _i('Username') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="name"
                                class="col-md-4 col-form-label text-md-right">{{ _i('Full Name') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="country"
                                class="col-md-4 col-form-label text-md-right">{{ _i('Country of residence') }}</label>

                            <div class="col-md-6">
                                <select class="form-control selection" id="country" name="country">
                                    <option value="">&nbsp;</option>
                                    @foreach (Countries::getList(LaravelGettext::getLocaleLanguage()) as
                                    $code=>$country)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control selection" id="observationlanguage"
                                    name="observationlanguage">
                                    <option value="">&nbsp;</option>
                                    @foreach (Languages::lookup('major', LaravelGettext::getLocaleLanguage()) as
                                    $code=>$language)
                                    @if (old('observationlanguage') != '')
                                    <option value="{{ $code }}" @if ($code==old('observationlanguage'))
                                        selected="selected" @endif>{{ ucfirst($language) }}</option>
                                    @else
                                    <option value="{{ $code }}" @if ($code==LaravelGettext::getLocaleLanguage())
                                        selected="selected" @endif>{{ ucfirst($language) }}</option>
                                    @endif
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control selection" id="language" name="language">
                                    ...
                                    @endphp
                                    @if (old('language') != '')
                                    <option value="{{ $locale }}" @if ($locale==old('language')) selected="selected"
                        ...
                        <div class="form-group row" name="license" id="license">
                            <label for="cclicense"
                                class="col-md-4 col-form-label text-md-right">{{ _i("License for drawings") }}</label>

                            <div class="col-md-6">
                                <select name="cclicense selection" id="cclicense" onchange="enableDisableCopyright();"
                                    class="form-control">
                                    <option value="0" @if (0==old('cclicense')) selected="cclicense" @endif>Attribution
                                        CC BY</option>
                                    <option value="1" @if (1==old('cclicense')) selected="cclicense" @endif>
                                        Attribution-ShareAlike CC BY-SA</option>
                                    <option value="2" @if (2==old('cclicense')) selected="cclicense" @endif>
                                        Attribution-NoDerivs CC BY-ND</option>
                                    <option value="3" @if (3==old('cclicense')) selected="cclicense" @endif>
                                        Attribution-NonCommercial CC BY-NC</option>
                                    <option value="4" @if (4==old('cclicense')) selected="cclicense" @endif>
                                        Attribution-NonCommercial-ShareAlike CC BY-NC-SA</option>
                                    <option value="5" @if (5==old('cclicense')) selected="cclicense" @endif>
                                        Attribution-NonCommercial-NoDerivs CC BY-NC-ND</option>
                                    <option value="6" @if (6==old('cclicense')) selected="cclicense" @endif>
                                        {{ _i("No license (Not recommended!)") }}</option>
                                    <option value="7" @if (7==old('cclicense')) selected="cclicense" @endif>
                                ...
                                <span class="help-block">
                                    ...
                                    '<a
                                        href="http://creativecommons.org/choose/?lang=' . LaravelGettext::getLocale() . '">',
                                        '</a>');
                                    @endphp
                                </span>
                            </div>
                        ...
                        <div class="form-group row">
                            <label for="copyright"
                                class="col-md-4 col-form-label text-md-right">{{ _i('Copyright notice') }}</label>

                            <div class="col-md-6">
                                <input id="copyright" type="text" class="form-control" maxlength="128" name="copyright"
                                    value="{{ old('copyright') }}">
                            </div>
                        </div>
