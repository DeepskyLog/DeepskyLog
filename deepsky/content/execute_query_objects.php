...
while(list($key,$value)=each($_GET))
  if(!(in_array($key,array('restoreColumns','orderColumns','loadLayout','saveLayout','sort','soretorder','multiplepagenr','noShowName','sortdirection'))))  
...
{ echo "<div id=\"main\">";
  ...
  if(array_key_exists('listname',$_SESSION)&&$_SESSION['listname']&&$myList)
	...
	$content1.="&nbsp;-&nbsp;";
	$content1.="<a href=\"".$baseURL."index.php?indexAction=reportsLayout&amp;reportname=execute_query_objects&amp;reporttitle=Query%20of%20Objects&amp;SID=Qobj&amp;sort=".$_SESSION['QobjSort']."&amp;pdfTitle=Test\" >"."Report"."</a>";
