  ...
  $objPresentations->line(array("<h4>".LangQueryObservationsTitle."</h4>",$content,$content1,$content2),"LRLL",array(20,20,40,20),30);
	...
	// MAXIMUM MAGNITUDE
	  ...
	  if(($maxMag=$objUtil->checkGetKey('maxmag'))=='')
		...
		echo "<input id=\"maxmag\" name=\"maxmag\" type=\"number\" min=\"-5\" max=\"24\" step=\"0.1\" class=\"inputfield centered\" maxlength=\"4\" size=\"5\" value=\"".$maxMag."\" />";
		echo "</td>";
	...
	// MINIMUM MAGNITUDE
	  ...
	  if(($minMag=$objUtil->checkGetKey('minmag'))=='')
		...
		echo "<input id=\"minmag\" name=\"minmag\" type=\"number\" min=\"-5\" max=\"24\" step=\"0.1\" class=\"inputfield centered\" maxlength=\"4\" size=\"5\" value=\"".$minMag."\" />";
		echo "</td>";
	...
	// MINIMIM SURFACE BRIGHTNESS
	  ...
	  if(($minSB=$objUtil->checkGetKey('minsb'))=='')
		...
		echo "<input id=\"minsb\" name=\"minsb\" type=\"number\" min=\"-5\" max=\"24\" step=\"0.1\" class=\"inputfield centered\" maxlength=\"4\" size=\"5\" value=\"".$minSB."\" />";
		echo "</td>";
	// MINIMIM SIZE
	...
	// MAXIMUM SURFACE BRIGHTNESS
	  ...
	  if(($maxSB=$objUtil->checkGetKey('maxsb'))=='')
		...
		echo "<input id=\"maxsb\" name=\"maxsb\" type=\"number\" min=\"-5\" max=\"24\" step=\"0.1\" class=\"inputfield centered\" maxlength=\"4\" size=\"5\" value=\"".$maxSB."\" />";
		echo "</td>";
	// MAXIMUM SIZE
    ...
    echo "<input id=\"minday\" name=\"minday\" type=\"number\" min=\"1\" max=\"31\" class=\"inputfield centered\" maxlength=\"2\" size=\"3\" value=\"".$minday."\" />";
		echo "&nbsp;";
	  ...
	  if($minyear=='')
		...
		echo "<input id=\"minyear\" name=\"minyear\" type=\"number\" min=\"1609\" class=\"inputfield centered\" maxlength=\"4\" size=\"5\" value=\"".$minyear."\" />";
		echo "</td>";
	// MINIMUM DIAMETER
	  ...
	  echo "<input id=\"mindiameter\" name=\"mindiameter\" type=\"number\" min=\"0.01\" step=\"0.01\" class=\"inputfield centered\" maxlength=\"64\" size=\"10\" value=\"".$mindiameter."\"/>";
	...
	// MAXIMUM DATE
	  ...
	  if($maxday=='')
		...
		echo "<input id=\"maxday\" name=\"maxday\" type=\"number\" min=\"1\" max=\"31\" class=\"inputfield centered\" maxlength=\"2\" size=\"3\" value=\"".$maxday."\" />";
		echo "&nbsp;";
	  ...
	  if($maxyear=='')
		...
		echo "<input id=\"maxyear\" name=\"maxyear\" type=\"number\" min=\"1609\" class=\"inputfield centered\" maxlength=\"4\" size=\"5\" value=\"".$maxyear."\" />";
		echo "</td>";
	// MAXIMUM DIAMETER
	  ...
	  if(($maxdiameter=$objUtil->checkGetKey('maxdiameter'))=='')
		...
		echo "<input id=\"maxdiameter\" name=\"maxdiameter\" type=\"number\" min=\"0.01\" step=\"0.01\" class=\"inputfield centered\" maxlength=\"64\" size=\"10\" value=\"".$maxdiameter."\" />";
	...
	// MINIMUM Latitude
	  ...
	  if(($minLatSeconds=$objUtil->checkGetKey('minLatSeconds'))=='')
		...
		echo "<input id=\"minLatDegrees\" name=\"minLatDegrees\" type=\"number\" min=\"-90\" max=\"90\" class=\"inputfield centered\" maxlength=\"3\" size=\"4\" value=\"".$minLatDegrees."\" />&nbsp;&deg;&nbsp;";
		echo "<input id=\"minLatMinutes\" name=\"minLatMinutes\" type=\"number\" min=\"0\" max=\"59\" class=\"inputfield centered\" maxlength=\"2\" size=\"3\" value=\"".$minLatMinutes."\" />&nbsp;&#39;&nbsp;";
		echo "<input id=\"minLatSeconds\" name=\"minLatSeconds\" type=\"number\" min=\"0\" max=\"59\" class=\"inputfield centered\" maxlength=\"2\" size=\"3\" value=\"".$minLatSeconds."\" />&nbsp;&quot;&nbsp;";
		echo "</td>" ;
	// MINIMUM LIMITING MAGNITUDE
	  ...
	  if($minlimmag=='')
		...
		echo "<input id=\"minlimmag\" name=\"minlimmag\" type=\"number\" min=\"0.0\" max=\"9.9\" step=\"0.1\" class=\"inputfield centered\" maxlength=\"3\" size=\"4\" value=\"".$minlimmag."\" />";
		echo "</td>";
		echo "</tr>";
	// MAXIMUM latitude
  	echo "<tr>";
	  ...
	  if(($maxLatSeconds=$objUtil->checkGetKey('maxLatSeconds'))=='')
		...
		echo "<input id=\"maxLatDegrees\" name=\"maxLatDegrees\" type=\"number\" min=\"-90\" max=\"90\" class=\"inputfield centered\" maxlength=\"3\" size=\"4\" value=\"".$maxLatDegrees."\" />&nbsp;&deg;&nbsp;";
		echo "<input id=\"maxLatMinutes\" name=\"maxLatMinutes\" type=\"number\" min=\"0\" max=\"59\" class=\"inputfield centered\" maxlength=\"2\" size=\"3\" value=\"".$maxLatMinutes."\" />&nbsp;&#39;&nbsp;";
		echo "<input id=\"maxLatSeconds\" name=\"maxLatSeconds\" type=\"number\" min=\"0\" max=\"59\" class=\"inputfield centered\" maxlength=\"2\" size=\"3\" value=\"".$maxLatSeconds."\" />&nbsp;&quot;&nbsp;";
		echo "</td>" ;
	// MAXIMUM LIMITING MAGNITUDE
	  ...
	  if($maxlimmag=='')
		...
		echo "<input id=\"maxlimmag\" name=\"maxlimmag\" type=\"number\" min=\"0.0\" max=\"9.9\" step=\"0.1\" class=\"inputfield centered\" maxlength=\"3\" size=\"4\" value=\"".$maxlimmag."\" />";
		echo "</td>";
		echo "</tr>";
	// MINIMUM SEEING
		echo "<tr>";
