...
function selected_observations() {
	...
	if ((! (array_key_exists ( 'Qobs', $_SESSION ))) || count ( $_SESSION ['Qobs'] ) == 0) 	// ================================================================================================== no reult present =======================================================================================
	{
		...
		$content1 .= "  ";
		$content1 .= "<a class=\"btn btn-primary\" href=\"" . $baseURL . "observations.csv\" rel=\"external\"><span class=\"glyphicon glyphicon-download\"></span> " . _("CSV") . "</span></a> ";
		$content1 .= "<a class=\"btn btn-primary\" href=\"" . $baseURL . "observations.xml\" rel=\"external\"><span class=\"glyphicon glyphicon-download\"></span> " . _("<OAL>") . "</span></a> ";
		$content1 .= "<a class=\"btn btn-primary\" href=\"" . $baseURL . "observations.skylist\" rel=\"external\"><span class=\"glyphicon glyphicon-download\"></span> " . _("skylist") . "</span></a>";
		echo $content1;
		echo "<hr />";
		echo "</div>";
