<?php // selected_observations.php - generates an overview of selected observations in the database
...
{ if((array_key_exists('steps',$_SESSION))&&(array_key_exists("selObjObs".$_SESSION['lco'],$_SESSION['steps'])))
  ...
  if(!($collapsed))
  { $objPresentations->line(array("<h4>".$collapsedtext.LangViewObjectTitle."&nbsp;-&nbsp;".$object_ss."&nbsp;-&nbsp;".LangOverviewObjectsHeader7."&nbsp;:&nbsp;".$seen."</h4>",$objPresentations->getDSSDeepskyLiveLinks1($object)),
	                        "LR",array(50,50),30);
