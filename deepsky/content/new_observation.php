...
function new_observation() {
	...
	if ($object && ($objUtil->checkArrayKey ( $_SESSION, 'addObs', 0 ) == $objUtil->checkPostKey ( 'timestamp', - 1 ))) {
		echo "<form role=\"form\" action=\"" . $baseURL . "index.php\" method=\"post\" enctype=\"multipart/form-data\"><div>";
		...
		$contentDate = "<input type=\"number\" min=\"1\" max=\"31\" class=\"form-control\" maxlength=\"2\" size=\"3\"  name=\"day\" id=\"day\" value=\"" . $theDay . "\" onkeypress=\"return checkPositiveInteger(event);\" />";
		$contentDate .= "&nbsp;&nbsp;";
		$contentDate .= "<select name=\"month\" id=\"month\" class=\"form-control\">";
		for($i = 1; $i < 13; $i ++)
			$contentDate .= "<option value=\"" . $i . "\"" . (($theMonth == $i) ? " selected=\"selected\"" : "") . ">" . $GLOBALS ['Month' . $i] . "</option>";
		$contentDate .= "</select>";
		$contentDate .= "&nbsp;&nbsp;";
		$contentDate .= "<input type=\"number\" min=\"1609\" class=\"form-control\" maxlength=\"4\" size=\"4\"  name=\"year\" id=\"year\" onkeypress=\"return checkPositiveInteger(event);\" value=\"" . $theYear . "\" />";
		$contentTime = "<input type=\"number\" min=\"0\" max=\"23\" class=\"form-control\" maxlength=\"2\" size=\"3\"name=\"hours\" value=\"" . $theHour . "\" />";
		$contentTime .= "&nbsp;&nbsp;";
		...
		$contentVisibilityOc = "<select name=\"visibility\" id=\"visibility\" class=\"form-control\">";
		...
		$contentVisibilityDs = "<select name=\"visibility\" id=\"visibility\" class=\"form-control\">";
		...
		$contentDiameter = "<input type=\"number\" min=\"0.01\" step=\"0.01\" class=\"form-control\" maxlength=\"5\" name=\"largeDiam\" size=\"5\" value=\"" . $theDiameter1 . "\" />";
		$contentDiameter .= "&nbsp;x&nbsp;";
		$contentDiameter .= "<input type=\"number\" min=\"0.01\" step=\"0.01\" class=\"form-control\" maxlength=\"5\" name=\"smallDiam\" size=\"5\" value=\"" . $theDiameter2 . "\" />";
		$contentDiameter .= "&nbsp;";
