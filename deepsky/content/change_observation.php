<?php // change_observation.php - allows a user to change his observation 
if(!$_GET['observation'])
...
elseif(!($objUtil->checkAdminOrUserID($objObservation->getDsObservationProperty($_GET['observation'],'observerid')))) throw new Exception(LangException004);
else
{
...
echo "<div id=\"main\">";
$objPresentations->line(array("<h5>".LangChangeObservationTitle."</h5>"),"L",array(),50);
echo "<hr />";
...
{ echo "&nbsp;&nbsp;&nbsp;<input type=\"checkbox\" name=\"resolved\" ".($objUtil->checkPostKey("resolved")?"checked ":"")."/>" . LangViewObservationField37;
  ...
  echo "<td class=\"fieldname\">";
	...
	echo "</td>";
	echo "<td>";
	echo "<select name=\"clusterType\" class=\"inputfield\" style=\"width:300px\">";
	echo "<option value=\"\"" .            (($objObservation->getDsObservationProperty($_GET['observation'],'clusterType') == '') ? " selected=\"selected\" " : '') . "></option>";
	echo "<option value=\"" . "A" . "\"" . (($objObservation->getDsObservationProperty($_GET['observation'],'clusterType') == 'A') ? " selected=\"selected\" " : '') . ">A - ".$ClusterTypeA."</option>";
	echo "<option value=\"" . "B" . "\"" . (($objObservation->getDsObservationProperty($_GET['observation'],'clusterType') == 'B') ? " selected=\"selected\" " : '') . ">B - ".$ClusterTypeB."</option>";
	echo "<option value=\"" . "C" . "\"" . (($objObservation->getDsObservationProperty($_GET['observation'],'clusterType') == 'C') ? " selected=\"selected\" " : '') . ">C - ".$ClusterTypeC."</option>";
	echo "<option value=\"" . "D" . "\"" . (($objObservation->getDsObservationProperty($_GET['observation'],'clusterType') == 'D') ? " selected=\"selected\" " : '') . ">D - ".$ClusterTypeD."</option>";
	echo "<option value=\"" . "E" . "\"" . (($objObservation->getDsObservationProperty($_GET['observation'],'clusterType') == 'E') ? " selected=\"selected\" " : '') . ">E - ".$ClusterTypeE."</option>";
	echo "<option value=\"" . "F" . "\"" . (($objObservation->getDsObservationProperty($_GET['observation'],'clusterType') == 'F') ? " selected=\"selected\" " : '') . ">F - ".$ClusterTypeF."</option>";
	echo "<option value=\"" . "G" . "\"" . (($objObservation->getDsObservationProperty($_GET['observation'],'clusterType') == 'G') ? " selected=\"selected\" " : '') . ">G - ".$ClusterTypeG."</option>";
	echo "<option value=\"" . "H" . "\"" . (($objObservation->getDsObservationProperty($_GET['observation'],'clusterType') == 'H') ? " selected=\"selected\" " : '') . ">H - ".$ClusterTypeH."</option>";
	echo "<option value=\"" . "I" . "\"" . (($objObservation->getDsObservationProperty($_GET['observation'],'clusterType') == 'I') ? " selected=\"selected\" " : '') . ">I - ".$ClusterTypeI."</option>";
	echo "<option value=\"" . "X" . "\"" . (($objObservation->getDsObservationProperty($_GET['observation'],'clusterType') == 'X') ? " selected=\"selected\" " : '') . ">X - ".$ClusterTypeX."</option>";
	echo "</select>";
	echo "</td>";
	echo "</tr>";
	echo "<tr>";
