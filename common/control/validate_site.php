...
if(array_key_exists('adaption',$_GET) && ($_POST['adaption'] == 1))
{
...
if(array_key_exists('add', $_POST) && $_POST['add'])
{
	$id = $locations->addLocation($_POST['sitename'], $longitude, $latitude, $_POST['region'], $_POST['country'], $timezone);
          ...
          {
             $locations->setLocationLimitingMagnitude($id, $_POST['lm']);
          ...
          $locations->setLocationObserver($id, $_SESSION['deepskylog_id']);
...
{
          $locations->setLocationName($_POST['id'], $_POST['sitename']);
          ...
          $locations->setLocationObserver($_POST['id'], $_SESSION['deepskylog_id']);
