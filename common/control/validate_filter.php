...
{ $id=$objFilter->addFilter($objUtil->checkPostKey('filtername'), $objUtil->checkPostKey('type'), $objUtil->checkPostKey('color'), $objUtil->checkPostKey('wratten'), $objUtil->checkPostKey('schott'));
...
{ $objFilter->setFilterName($_POST['id'], $objUtil->checkPostKey('filtername'));
  ...
  $objFilter->setFilterColor($_POST['id'], $objUtil->checkPostKey('color'));
