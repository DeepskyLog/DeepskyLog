...
{ global $baseURL,$locationid,$loggedUser,
  ...
  $disabled=" disabled=\"disabled\"";
	...
	$line[]=array(LangAddSiteField2,"<input type=\"text\" class=\"inputfield\" maxlength=\"64\" name=\"region\" size=\"30\" value=\"".stripslashes($objLocation->getLocationPropertyFromId($locationid,'region'))."\"  ".$disabled." />",LangAddSiteField2Expl);
