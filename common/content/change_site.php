...
{  $disabled=" disabled=\"disabled\"";
	...
	$line[]=array(LangAddSiteField4,"<input type=\"text\" class=\"inputfield requiredField centered\" maxlength=\"3\" name=\"latitude\" size=\"4\" value=\"".$latitudedeg."\" ".$disabled." />&deg;<input type=\"text\" class=\"inputfield requiredField centered\" maxlength=\"2\" name=\"latitudemin\" size=\"2\" value=\"".abs($latitudemin) . "\"  ".$disabled." />&#39;",LangAddSiteField4Expl);
	$line[]=array(LangAddSiteField5,"<input type=\"text\" class=\"inputfield requiredField centered\" maxlength=\"4\" name=\"longitude\" size=\"4\" value=\"".$longitudedeg."\" ".$disabled." />&deg;<input type=\"text\" class=\"inputfield requiredField centered\" maxlength=\"2\" name=\"longitudemin\" size=\"2\" value=\"".abs($longitudemin)."\"  ".$disabled." />&#39;",LangAddSiteField5Expl);
