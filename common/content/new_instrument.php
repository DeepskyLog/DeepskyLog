...
function new_instrument() {
	...
	echo "<hr />";
	echo "<input type=\"submit\" class=\"btn btn-success pull-right tour2\" name=\"add\" value=\"" . _("Add instrument") . "\" />&nbsp;";
	...
	echo "</div>";
	echo "<span class=\"help-block\">" . _("Only for binoculars, finder scopes, ...") . "</span>";
	echo "</div>";

	echo "<hr />";
	echo "<input type=\"submit\" class=\"btn btn-success\" name=\"add\" value=\"" . _("Add instrument") . "\" />&nbsp;";
	echo "</div></form>";
	echo "</div>";
}
?>
