...
echo "</tr>";
echo "<tr class=\"type1\">";
echo "<td class=\"fieldname\">".LangChangeAccountField8."</td>";
echo "<td colspan=\"".sizeof($modules)."\">";
...
{ echo "<tr class=\"type2\">";
  ...
  if($objUtil->checkSessionKey('user')&&($user!="admin"))                       // normal user
...
echo "</tr>";
echo "<tr>";
echo "<td class=\"type1\">".LangTopObserversHeader6."</td>";
for ($i = 0;$i < count($modules);$i++)
