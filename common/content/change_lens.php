...
$objPresentations->line(array("<h4>".stripslashes($objLens->getLensPropertyFromId($lensid,'name'))."</h4>","<input type=\"submit\" name=\"change\" value=\"".LangChangeLensButton."\" />&nbsp;"),"LR",array(80,20),30); 
echo "<hr />";
