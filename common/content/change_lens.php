...
echo "<div id=\"main\">";
echo "<h2>".stripslashes($objLens->getLensPropertyFromId($_GET['lens'],'name'))."</h2>"; 
...
tableFieldnameFieldExplanation(LangAddLensField1,
                               "<input type=\"text\" class=\"inputfield requiredField\" maxlength=\"64\" name=\"lensname\" size=\"30\" value=\"".stripslashes($objLens->getLensPropertyFromId($_GET['lens'],'name'))."\" />",
                               LangAddLensField1Expl);
tableFieldnameFieldExplanation(LangAddLensField2,
                               "<input type=\"text\" class=\"inputfield requiredField\" maxlength=\"5\" name=\"factor\" size=\"5\" value=\"".stripslashes($objLens->getLensPropertyFromId($_GET['lens'],'factor'))."\" />",
