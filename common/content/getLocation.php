...
{ echo "<div class=\"results\">".LangGetLocation2."</div>";
  ...
  { $vars = explode("\t", $value);
    ...
    echo "<td>";
    echo "<a href=".$baseURL."\"common/indexCommon.php?indexAction=add_site&amp;sitename=$vars[0]&amp;longitude=$vars[1]&amp;latitude=$vars[2]&amp;region=$vars[4]&amp;country=$vars[3]\">$vars[0]</a> </td><td>". decToString($vars[1], 1) ."</td><td>". decToString($vars[2], 1) ."</td><td> $vars[4] </td><td> $vars[3]";
    echo "</td>";
    echo "</tr>";
    $count++;
  }
