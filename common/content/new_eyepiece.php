...
{ global $baseURL,$loggedUserName,
  ...
  $mfl = $objUtil->checkRequestKey('maxFocalLength',-1);
	...
	$objPresentations->line(array(LangAddEyepieceField1,
	                              "<input type=\"text\" required class=\"inputfield requiredField\" maxlength=\"64\" name=\"eyepiecename\" size=\"30\" value=\"".stripslashes($objUtil->checkRequestKey('eyepiecename')).stripslashes($objEyepiece->getEyepiecePropertyFromId($objUtil->checkRequestKey('eyepieceid'),'name'))."\" />",
	...
	$objPresentations->line(array(LangAddEyepieceField2,
	                              "<input type=\"number\" min=\"0\" max=\"100\" step=\"0.01\" required class=\"inputfield requiredField centered\" maxlength=\"5\" name=\"focalLength\" size=\"5\" value=\"".stripslashes($objEyepiece->getEyepiecePropertyFromId($objUtil->checkRequestKey('eyepieceid'),'focalLength',$objUtil->checkRequestKey('focalLength')))."\" />",
	                              LangAddEyepieceField2Expl),
	                        "RLL",array(25,40,35),'',array("fieldname","fieldvalue","fieldexplanation"));
	$objPresentations->line(array(LangAddEyepieceField4,
	                              "<input type=\"number\" min=\"0\" max=\"100\" step=\"0.01\" class=\"inputfield centered\" maxlength=\"5\" name=\"maxFocalLength\" size=\"5\" value=\"".$mfl."\" />",
	                              LangAddEyepieceField4Expl),
	                        "RLL",array(25,40,35),'',array("fieldname","fieldvalue","fieldexplanation"));
	$objPresentations->line(array(LangAddEyepieceField3,
	                               "<input type=\"number\" min=\"1\" max=\"180\" step=\"0.01\" required class=\"inputfield requiredField centered\" maxlength=\"5\" name=\"apparentFOV\" size=\"5\" value=\"".stripslashes($objEyepiece->getEyepiecePropertyFromId($objUtil->checkRequestKey('eyepieceid'),'apparentFOV',$objUtil->checkRequestKey('apparentFOV')))."\" />",
