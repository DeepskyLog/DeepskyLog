...
echo "<td><input value=\"".$name."\" type=\"text\" class=\"inputfield\" maxlength=\"64\" name=\"instrumentname\" size=\"30\" /></td>";
echo "</tr>";
echo "<tr>";
echo "<td class=\"fieldname\">".LangAddInstrumentField2."</td>";
echo "<td><input value=\"".round($objInstrument->getDiameter($_GET['instrument']), 0)."\" type=\"text\" class=\"inputfield\" maxlength=\"64\" name=\"diameter\" size=\"10\" />";
...
echo "<td><input value=\"".(($fl=round($objInstrument->getInstrumentFocalLength($_GET['instrument']), 0))?$fl:"")."\" type=\"text\" class=\"inputfield\" maxlength=\"64\" name=\"focallength\" size=\"10\" />";
...
echo "<td><input type=\"text\" class=\"inputfield\" maxlength=\"64\" name=\"fd\" size=\"10\" /></td>";
echo "</tr>";
echo "<tr>";
echo "<td class=\"fieldname\">".LangAddInstrumentField6."</td>";
echo "<td>";
echo "<input value=\"".(($fm=$objInstrument->getFixedMagnification($_GET['instrument']))?$fm:"")."\" type=\"text\" class=\"inputfield\" maxlength=\"64\" name=\"fixedMagnification\" size=\"10\" />";
echo "</td>";
echo "</tr>";
echo "<tr>";
echo "<td>&nbsp;</td>";
