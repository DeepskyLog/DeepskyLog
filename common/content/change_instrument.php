...
echo "<td><input value=\"".round($objInstrument->getDiameter($_GET['instrument']), 0)."\" type=\"text\" class=\"inputfield requiredField\" maxlength=\"64\" name=\"diameter\" size=\"10\" />";
...
echo "<td><input value=\"".(($fl=round($objInstrument->getInstrumentFocalLength($_GET['instrument']), 0))?$fl:"")."\" type=\"text\" class=\"inputfield requiredField\" maxlength=\"64\" name=\"focallength\" size=\"10\" />";
