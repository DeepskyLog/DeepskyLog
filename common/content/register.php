...
{ global $baseURL, $step, $defaultLanguage, $languagesDuringRegistration , $standardLanguagesForObservationsDuringRegistration,
	...
	echo "<hr />";
	$objPresentations->line(array(LangChangeAccountField1,"<input type=\"text\" class=\"inputfield requiredField\" maxlength=\"64\" name=\"deepskylog_id\" required placeholder=\"" . LangChangeAccountField1Expl . "\"size=\"50\" value=\"".$objUtil->checkPostKey('deepskylog_id')."\" />"),"RL",array(20,80),array('fieldname','fieldvalue'));
	$objPresentations->line(array(LangChangeAccountField2,"<input type=\"email\" class=\"inputfield requiredField\" maxlength=\"64\" name=\"email\" size=\"50\" required placeholder=\"" . LangChangeAccountField2Expl . "\" value=\"".$objUtil->checkPostKey('email')."\" />"),"RL",array(20,80),array('fieldname','fieldvalue'));
	$objPresentations->line(array(LangChangeAccountField3,"<input type=\"text\" class=\"inputfield requiredField\" maxlength=\"64\" name=\"firstname\" size=\"50\" required placeholder=\"" . LangChangeAccountField3Expl . "\" value=\"".$objUtil->checkPostKey('firstname')."\" />"),"RL",array(20,80),'',array('fieldname','fieldvalue'));
	$objPresentations->line(array(LangChangeAccountField4,"<input type=\"text\" class=\"inputfield requiredField\" maxlength=\"64\" name=\"name\" size=\"50\" required placeholder=\"" . LangChangeAccountField4Expl . "\" value=\"".$objUtil->checkPostKey('name')."\" />"),"RL",array(20,80),'',array('fieldname','fieldvalue'));
	$objPresentations->line(array(LangChangeAccountField13,"<input type=\"text\" class=\"inputfield requiredField\" maxlength=\"64\" name=\"motivation\" size=\"120\" required placeholder=\"" . LangChangeAccountField13Expl . "\" value=\"".$objUtil->checkPostKey('explanation')."\" />"),"RL",array(20,80),'',array('fieldname','fieldvalue'));
	$objPresentations->line(array(LangChangeAccountField5,"<input type=\"password\" class=\"inputfield requiredField\" maxlength=\"64\" name=\"passwd\" size=\"50\" required placeholder=\"" . LangChangeAccountField5Expl . "\" value=\"".$objUtil->checkPostKey('passwd')."\" />"),"RL",array(20,80),'',array('fieldname','fieldvalue'));
	$objPresentations->line(array(LangChangeAccountField6,"<input type=\"password\" class=\"inputfield requiredField\" maxlength=\"64\" name=\"passwd_again\" size=\"50\" required placeholder=\"" . LangChangeAccountField6Expl . "\" value=\"".$objUtil->checkPostKey('passwd_again')."\" />"),"RL",array(20,80),'',array('fieldname','fieldvalue'));
