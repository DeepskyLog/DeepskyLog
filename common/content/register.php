...
{ global $baseURL, $step, $defaultLanguage, $languagesDuringRegistration , $standardLanguagesForObservationsDuringRegistration,
	...
	$objPresentations->line(array(LangChangeAccountField13,"<input type=\"text\" class=\"inputfield requiredField\" maxlength=\"64\" name=\"motivation\" size=\"99\" value=\"".$objUtil->checkPostKey('explanation')."\" />",LangChangeAccountField13Expl),"RLL",array(20,40,40),'',array('fieldname','fieldvalue','fieldexplanation'));
