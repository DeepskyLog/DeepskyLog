...
function new_message() {
	...
	if ($loggedUser != "") {
		...
		echo "<h4>" . _('New message');
        $content = "<button class=\"pull-right btn btn-success\" type=\"submit\" name=\"newmessage\" />" 
		...
		if ($receiverId == "all") {
			$receiverName = _('All DeepskyLog users');
		} else {
		...
		echo "<label class=\"col-sm-2 control-label\">" . _('Sender') . "</label>";
		echo "<div class=\"col-sm-5\"><p class=\"form-control-static\">" . $senderName . "</p>";
		echo "</div></div>";

		echo "<div class=\"form-group\">";
		echo "<label class=\"col-sm-2 control-label\">" . _('Receiver') . "</label>";
		...
		echo "<div class=\"form-group\">
	         <label for=\"subject\" class=\"col-sm-2 control-label\">" . _('Subject') . "</label>
		...
		echo "<div class=\"form-group\">
	         <label for=\"subject\" class=\"col-sm-2 control-label\">" . _('Message') . "</label>
