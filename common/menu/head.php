...
class head
{
   function printHeader($title)
   {
 	 ...
 	 echo "<META NAME=\"copyright\" CONTENT=\"Copyright &copy; 2005-2006 VVS. Alle Rechten Voorbehouden.\">";
 	 echo "<META NAME=\"author\" CONTENT=\"DeepskyLog - VVS\">";
 	 echo "<title>DeepskyLog ". $GLOBALS['objUtil']->checkGetKey('indexAction','')."</title>";
