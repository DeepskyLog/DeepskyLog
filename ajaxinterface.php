...
function ajaxinterface() {
	global $loggedUser, $objEyepiece, $objFilter, $objLens, $objLocation, $objInstrument, $objObject, $objStar, $objUtil, $objReportLayout, $objObserverQueries, $objPrintAtlas, $objConstellation, $objCatalog;
	...
	elseif ($ajaxInstruction == "atlasPages") {
		echo $objPrintAtlas->pdfAtlasAtlasPages ( $_GET ['item'] );
